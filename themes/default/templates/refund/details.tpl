    ...
    <tr>
        <td>
            <table width="100%" cellpadding="4" cellspacing="0" border="0" >
                {section name=i loop=$refund_details}
                    <tr>                    
                        <td class="menuhead2" width="80%">{$translate_refund_details_title}</td>
                        <td class="menuhead2" width="20%" align="right" valign="middle">
                            <a href="?page=refund:edit&refund_id={$refund_details[i].REFUND_ID}&page_title={$translate_refund_edit_title}" ><img src="{$theme_images_dir}icons/edit.gif"  alt="" height="16" border="0">{$translate_refund_details_edit}</a>&nbsp;
                            <a>
                                    ...
                                    <td class="menutd">                             
                                        <table class="olotable" border="0" cellpadding="5" cellspacing="5" width="100%" summary="Customer Contact">
                                            ...
                                            <tr>
                                                ...
                                                <td class="menutd">
                                                    {if $refund_details[i].REFUND_TYPE ==1}{$translate_refund_type_1}{/if}
                                                    {if $refund_details[i].REFUND_TYPE ==2}{$translate_refund_type_2}{/if}
                                                    {if $refund_details[i].REFUND_TYPE ==3}{$translate_refund_type_3}{/if}
                                                    {if $refund_details[i].REFUND_TYPE ==4}{$translate_refund_type_4}{/if}
                                                    {if $refund_details[i].REFUND_TYPE ==5}{$translate_refund_type_5}{/if}
                                                </td>
                                            ...
                                            <tr>
                                                ...
                                                <td class="menutd">
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==1}{$translate_refund_payment_method_1}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==2}{$translate_refund_payment_method_2}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==3}{$translate_refund_payment_method_3}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==4}{$translate_refund_payment_method_4}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==5}{$translate_refund_payment_method_5}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==6}{$translate_refund_payment_method_6}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==7}{$translate_refund_payment_method_7}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==8}{$translate_refund_payment_method_8}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==9}{$translate_refund_payment_method_9}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==10}{$translate_refund_payment_method_10}{/if}
                                                    {if $refund_details[i].REFUND_PAYMENT_METHOD ==11}{$translate_refund_payment_method_11}{/if}
                                                </td>
                                            ...
                                            {assign var="refund_id" value=$refund_details[i].REFUND_ID}                    
                                        </table>
                                    </td>
                                </tr>
                            </table>
