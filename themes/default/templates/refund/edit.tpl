                                                ...
                                                <table width="100%" cellpadding="2" cellspacing="2" border="0">  
                                                    ...
                                                    <form action="index.php?page=refund:edit&refund_id={$refund_id}" method="post" name="edit_refund" id="edit_refund" autocomplete="off">                                                        
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="net_amount" class="olotd5" size="10" value="{$refund_details.net_amount}" type="text" maxlength="10" pattern="{literal}^[0-9]{1,7}(.[0-9]{0,2})?${/literal}" onkeydown="return onlyNumberPeriod(event);"></b></a></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><span style="color: #ff0000"></span><b>{t}VAT/Tax{/t} {t}Rate{/t}</b></td>
                                                            <td><input name="tax_rate" class="olotd5" size="5" value="{$refund_details.tax_rate}" type="text" maxlength="5" pattern="{literal}^[0-9]{0,2}(\.[0-9]{0,2})?${/literal}" required onkeydown="return onlyNumberPeriod(event);"/><b>%</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><b>{t}VAT/Tax{/t} {t}Amount{/t}</b></td>
                                                            <td><input name="tax_amount" class="olotd5" size="10" value="{$refund_details.tax_amount}" type="text" maxlength="10" pattern="{literal}^[0-9]{1,7}(.[0-9]{0,2})?${/literal}" onkeydown="return onlyNumberPeriod(event);"/></td>
                                                        </tr>
                                                        <tr>
