                                                    ...
                                                    {section name=i loop=$refund_search_result}                                                            
                                                        ...
                                                        <tr onmouseover="this.className='row2'" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=refund:refund_details&refund_id={$refund_search_result[i].REFUND_ID}&page_title={$translate_refund_details_title}';" class="row1">                                                                
                                                            ...
                                                            <td class="olotd4" nowrap>
                                                                {if $refund_search_result[i].REFUND_TYPE ==1}{$translate_refund_type_1}{/if}
                                                                {if $refund_search_result[i].REFUND_TYPE ==2}{$translate_refund_type_2}{/if}
                                                                {if $refund_search_result[i].REFUND_TYPE ==3}{$translate_refund_type_3}{/if}
                                                                {if $refund_search_result[i].REFUND_TYPE ==4}{$translate_refund_type_4}{/if}
                                                                {if $refund_search_result[i].REFUND_TYPE ==5}{$translate_refund_type_5}{/if}
                                                            </td>                                                                
                                                            <td class="olotd4" nowrap>
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==1}{$translate_refund_payment_method_1}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==2}{$translate_refund_payment_method_2}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==3}{$translate_refund_payment_method_3}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==4}{$translate_refund_payment_method_4}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==5}{$translate_refund_payment_method_5}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==6}{$translate_refund_payment_method_6}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==7}{$translate_refund_payment_method_7}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==8}{$translate_refund_payment_method_8}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==9}{$translate_refund_payment_method_9}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==10}{$translate_refund_payment_method_10}{/if}
                                                                {if $refund_search_result[i].REFUND_PAYMENT_METHOD ==11}{$translate_refund_payment_method_11}{/if}
                                                            </td>                                                                
                                                            ...
                                                            <td class="olotd4" nowrap>{if !$refund_search_result[i].REFUND_NOTES == ""}
                                                                <img src="{$theme_images_dir}icons/16x16/view.gif" border="0" alt="" onMouseOver="ddrivetip('<b>{$translate_refund_notes}</b><hr><p>{$refund_search_result[i].REFUND_NOTES|nl2br|regex_replace:"/[\r\t\n]/":" "}</p>');" onMouseOut="hideddrivetip();">{/if}
                                                            </td>                                                               
