                        ...
                        <table width="100%" class="olotable" cellpadding="5" cellspacing="0" border="0">
                            <tr>
                                <td width="100%" valign="top">                                    
                                    <form action="index.php?page=setup:install" method="post" name="new_user" id="new_user" onsubmit="return confirmPasswordsMatch();"> 
                                                                ...
                                                                <table class="olotable" width="100%" cellpadding="5" cellspacing="0" border="0">
                                                                    ...
                                                                    <tr>                                                                        
                                                                        <td colspan="2">
                                                                            ...
                                                                            <button class="olotd5" type="submit" name="submit" value="stage7">{t}Submit{/t}</button>
                                                                        </td>
                                                                    </tr>
