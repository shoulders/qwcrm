...
<form method="post" action="index.php?page=setup:install">                   
     <table width="600" cellpadding="5" cellspacing="0" border="0">
         <tr>
             <td class="menuhead2" width="80%">&nbsp;{t}QWcrm Install The Database{/t}</td>
        ...
        <tr>
            <td colspan="2" style="text-align: center;">
                ...
                <button class="olotd5" type="submit" name="submit" value="stage3">{t}Submit{/t}</button>
            </td>
        </tr>        
    </table>
</form>