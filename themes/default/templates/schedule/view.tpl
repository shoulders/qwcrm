                                    ...
                                    <table width="100%" cellpadding="5" cellspacing="5">
                                        <tr>
                                            <td>
                                                ...
                                                <button type="button" onClick="window.location='?page=schedule:edit&schedule_id={$schedule_details.SCHEDULE_ID}';">{$translate_schedule_edit}</button>
                                                ...
                                                <button type="button" onClick="window.location='?page=schedule:icalendar&schedule_id={$schedule_details.SCHEDULE_ID}&theme=print';">Export</button>                                         
                                                <button type="button" onClick="window.location='?page=workorder:details&workorder_id={$schedule_details.WORKORDER_ID}';">View Work Order</button>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
