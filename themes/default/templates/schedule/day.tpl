            ...
            <table width="700" cellpadding="4" cellspacing="0" border="0">
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">                        
                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=tooltip}SCHEDULE_DAY_HELP_TITLE{/t}</strong></div><hr><div>{t escape=tooltip}ESCHEDULE_DAY_SEARCH_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">
                    </td>
                </tr>
                <tr>
