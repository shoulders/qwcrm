                                ...
                                <td class="menutd">
                                    <table width="100%" celpadding="5" cellspacing="5">
                                        <tr>
                                            ...
                                            <br>
                                            <a href="?page=schedule:edit&sch_id={$arr[a].SCHEDULE_ID}&y={$y}&m={$m}&d={$d}">{$translate_schedule_edit}</a> <a href="?page=schedule:delete&sch_id={$arr[a].SCHEDULE_ID}&y={$y}&m={$m}&d={$d}">{$translate_schedule_delete}</a> <a href="?page=workorder:details&wo_id={$arr[a].WORK_ORDER_ID}">View Work Order</a>
                                            {/section}
