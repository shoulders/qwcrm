                                            ...
                                            <td valign="top">
                                                <form id="1"><a href="?page=parts:status&submit=submit&page_no=1">
                                                    ...
                                                    <select name="page_no" onChange="changePage()">
                                                        ...
                                                        {/section}
                                                        <option value="?page=parts:status&submit=submit&page_no={$total_pages}" {if $page_no == $total_pages} selected {/if}>{$translate_parts_page} {$total_pages} {$translate_parts_of} {$total_pages}</option>
                                                    </select>
                                                    {if $next != ''}
