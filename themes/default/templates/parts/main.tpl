    ...
    {section name=q loop=$CAT}
        ...
        {section name=w loop=$SUB_CAT}
            {if $SUB_CAT[w].CAT == $CAT[q].ID}
                {literal}selbox.options[selbox.options.length] = new Option({/literal}'{$SUB_CAT[w].DESCRIPTION}','{$SUB_CAT[w].SUB_CATEGORY}'{literal});{/literal}                
            {/if}
        {/section}
        {literal}
         }
                                    ...
                                    <table width="100%">
                                        <tr>
                                            <td valign="top" width="75%">                                        
                                                ...
                                                <p>{$translate_parts_msg_2}</p>
                                                <p>{$translate_parts_msg_3}</p>
                                                <p>{$translate_parts_msg_4}</p>                                        
                                                {if $crm_msg != ''}
                                                        ...
                                                        <tr>
                                                            <td>
                                                                <table class="error" width="100%" border="0" cellpadding="5" cellspacing="5">
                                                                    <tr>
                                                                        <td valign="middle"><span>{$crm_msg}</span><br></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <table class="olotable" width="100%" cellpadding="3" cellspacing="0" border="0">
                                                            ...
                                                            {section name=p loop=$parts}
                                                                <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" class="row1">
                                                                    ...
                                                                    <td class="olotd4" align="center" valign="middle">{$currency_sym}{$parts[p].PRICE}</td>                                                                   
                                                    ...
                                                    <table class="olotable" width="100%" cellpadding="3" cellspacing="0" border="0">
                                                        ...
                                                        {section name=a loop=$cart_contents}
                                                            <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" class="row1">
                                                                ...
                                                                <td class="olotd4" align="right" valign="middle">{$currency_sym}{$cart_contents[a].PRICE|string_format:"%.2f"}</td>
                                                                <td class="olotd4" align="right" valign="middle">{$currency_sym}{$cart_contents[a].SUB_TOTAL|string_format:"%.2f"}
