        ...
        <tr>
            <td>
                <div id="tabs_container">
                    <ul class="tabs">
                        <li class="active"><a href="#" rel="#tab_1_contents" class="tab"><img src="{$theme_images_dir}icons/key.png" alt="" border="0" height="14" width="14"/>&nbsp;{t}Company Details{/t}</a></li>
                        <li><a href="#" rel="#tab_2_contents" class="tab"><img src="{$theme_images_dir}icons/money.png" alt="" border="0" height="14" width="14"/>&nbsp;{t}Localisation Setup{/t}</a></li>
                        <li><a href="#" rel="#tab_3_contents" class="tab"><img src="{$theme_images_dir}icons/16x16/email.jpg" alt="" border="0" height="14" width="14" />&nbsp;{t}Email Setup{/t}</a></li>
                        <li><a href="#" rel="#tab_4_contents" class="tab"><img src="{$theme_images_dir}icons/16x16/email.jpg" alt="" border="0" height="14" width="14" />&nbsp;{t}Email Messages{/t}</a></li>
                    </ul>
                                                ...
                                                <td width="100%" valign="top">                                     
                                                    <table cellpadding="5" cellspacing="0">                                                        
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="company_currency_code" class="olotd5" size="5" value="{$company_details.CURRENCY_CODE}" type="text" maxlength="3" required onkeydown="return onlyAlpha(event);">eg: "USD" = US Dollars, "AUD" = Australian Dollars, "GBP" = British Pound.</td>
                                                        </tr>
                                                        <tr>
