                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select class="olotd5" name="conn_type">
                                                                    ...
                                                                    <option value="" {if $company_details.EMAIL_CONNECTION_TYPE != 'SSL' } selected{/if}>None</option>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="left"><b>Enabled:</b>
                                                                <select id="new_wo_enabled">
                                                                    <option value="1" {if $company_details.EMAIL_MSG_WO_CREATED_ACTIVE == '1'} selected{/if}>Yes</option>
                                                                    <option value="0" {if $company_details.EMAIL_MSG_WO_CREATED_ACTIVE == '0'} selected{/if}>No</option>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            <td align="left"><b>Enabled:</b>
                                                                <select id="new_invoice_enabled">
                                                                    <option value="1" {if $company_details.EMAIL_MSG_NEW_INVOICE_ACTIVE == '1'} selected{/if}>Yes</option>
                                                                    <option value="0" {if $company_details.EMAIL_MSG_NEW_INVOICE_ACTIVE == '0'} selected{/if}>No</option>
                                                                </select>
                                                            </td>
                                                        </tr>
                                                        <tr>
