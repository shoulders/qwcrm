                                                    ...
                                                    {section name=i loop=$search_result}
                                                        ...
                                                        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=supplier:details&supplier_id={$search_result[i].supplier_id}';" class="row1">                                                           
                                                            ...
                                                            <td class="olotd4" nowrap>{if $search_result[i].notes != ''}
                                                                <img src="{$theme_images_dir}icons/16x16/view.gif" border="0" alt="" onMouseOver="ddrivetip('<div><strong>{t}Notes{/t}</strong></div><hr><div>{$search_result[i].notes|nl2br|regex_replace:"/(\t|')/":" "}</div>');" onMouseOut="hideddrivetip();">{/if}
                                                            </td>                                                            
                                                            <td class="olotd4" nowrap><img src="{$theme_images_dir}icons/16x16/view.gif" border="0" alt="" onMouseOver="ddrivetip('<div><strong>{t}Description{/t}</strong></div><hr><div>{$search_result[i].description|nl2br|regex_replace:"/(\t|')/":" "}</div>');" onMouseOut="hideddrivetip();"></td>                                                            
                                                            <td class="olotd4" nowrap>
