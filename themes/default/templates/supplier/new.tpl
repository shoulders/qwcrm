                                                                ...
                                                                <table>
                                                                    <tbody align="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input name="first_name" class="olotd5" size="20" type="text" maxlength="20" onkeydown="return onlyAlpha(event);"/></td>
                                                                        <tr>
                                                                            <td align="right"><strong>{t}Last Name{/t}</strong></td>
                                                                            <td><input name="last_name" class="olotd5" size="20" type="text" maxlength="20" onkeydown="return onlyAlpha(event);"/></td>
                                                                        </tr>
                                                                        <tr>
