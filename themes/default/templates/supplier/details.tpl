...
<table width="700" border="0" cellpadding="20" cellspacing="5">
    <tr>
        <td>
            {section name=i loop=$supplier_details}
                <table width="100%" cellpadding="4" cellspacing="0" border="0" >
                    <tr>
                        <td class="menuhead2" width="80%">{$translate_supplier_details_title}</td>
                        <td class="menuhead2" width="20%" align="right" valign="middle">
                            <a href="?page=supplier:edit&supplier_id={$supplier_details[i].SUPPLIER_ID}&page_title={$translate_supplier_edit_title}">
                                    ...
                                    <td class="menutd">
                                        <table class="olotable" border="0" cellpadding="5" cellspacing="5" width="100%" summary="Customer Contact">
                                            ...
                                            <tr>
                                                ...
                                                <td class="menutd">
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==1}{$translate_supplier_type_1}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==2}{$translate_supplier_type_2}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==3}{$translate_supplier_type_3}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==4}{$translate_supplier_type_4}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==5}{$translate_supplier_type_5}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==6}{$translate_supplier_type_6}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==7}{$translate_supplier_type_7}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==8}{$translate_supplier_type_8}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==9}{$translate_supplier_type_9}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==10}{$translate_supplier_type_10}{/if}
                                                    {if $supplier_details[i].SUPPLIER_TYPE ==11}{$translate_supplier_type_11}{/if}
                                                </td>
                                            ...
                                            {assign var="supplier_id" value=$supplier_details[i].SUPPLIER_ID}                                            
                                        </table>
                                    </td>
                                </tr>
                            </table>
