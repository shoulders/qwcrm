            ...
            <div style="float: left" id="main_menu" class="sdmenu">
                ...
                <div>
                    ...
                    {if $customer_id > 0 }
                        ...
                        <a href="?page=giftcert:new&customer_id={$customer_id}"><img src="{$theme_images_dir}icons/gift.png" alt="" border="0" height="14" width="14" /> {$translate_core_menu_new_gift_certificate}</a>
                        ...
                        <a href="?page=customer:note_new&customer_id={$customer_id}"><img src="{$theme_images_dir}icons/16x16/email.jpg" alt="" border="0" height="14" width="14" />New Memo</a>
                    {/if}        
                </div>
                ...
                {if $login_account_type_id == 1 || $login_account_type_id == 2}
                    <div>
                        ...
                        {if $supplier_id > 0 }
                            ...
                            <a href="?page=supplier:delete&supplier_id={$supplier_id}" onclick="return confirmDelete('{$translate_supplier_delete_mes_confirmation}');"><img src="{$theme_images_dir}icons/delete.gif" alt="" border="0" height="14" width="14" /> {$translate_core_menu_delete_supplier}</a>
                        {/if}
                    </div>
                {/if}
                ...
                {if $login_account_type_id == 1}
                    <div>
                        ...
                        <a href="?page=invoice:invoice_rates"><img src="{$theme_images_dir}icons/money.png" alt="" border="0" height="14" width="14" /> {$translate_core_menu_invoice_rates}</a>
                        <a href="?page=payment:options"><img src="{$theme_images_dir}icons/money.png" alt="" border="0" height="14" width="14" /> {$translate_core_menu_payment_options}</a>
                    </div>
                {/if}
