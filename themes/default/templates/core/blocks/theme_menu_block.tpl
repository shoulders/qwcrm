            ...
            <div style="float: left" id="my_menu" class="sdmenu">
                ...
                <div>
                    ...
                    {if $customer_id > 0 }
                        ...
                        <a href="?page=billing:new_gift&customer_id={$customer_id}"><img src="{$theme_images_dir}icons/gift.png" alt="" border="0" height="14" width="14" /> {$translate_core_menu_new_gift_certificate}</a>
                ...
                {if $login_account_type_id == 1 || $login_account_type_id == 4}
                    <div>
                        ...
                        <!-- Employees -->
                        <a href="?page=employee:search" ><img src="{$theme_images_dir}icons/16x16/viewmag.gif" alt="" border="0" height="14" width="14" /> {$translate_core_menu_view_employees}</a>
