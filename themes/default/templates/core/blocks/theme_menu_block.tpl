        ...
        <td>
            <div style="float: left" id="main_menu" class="sdmenu">
                ...
                <div>
                    ...
                    {/if}
                    <a href="index.php?page=invoice:open"><img src="{$theme_images_dir}icons/warning.gif" alt="" border="0" height="14" width="14" /> {t}Open{/t}</a> 
                ...
                {if $login_usergroup_id == 1 || $login_usergroup_id == 2 || $login_usergroup_id == 5}
                    <div>
                        ...
                        {if $expense_id > 0 }
                            ...
                            <a href="index.php?page=expense:delete&expense_id={$expense_id}" onclick="return confirmChoice('{t}Are you sure you want to delete this Expense Record?{/t}');"><img src="{$theme_images_dir}icons/delete.gif" alt="" border="0" height="14" width="14" /> {t}Delete{/t}</a>
                        {/if}                        
                    </div>
                {/if}
                ...
                {if $login_usergroup_id == 1 || $login_usergroup_id == 2 || $login_usergroup_id == 5}
                    <div>
                        ...
                        {if $refund_id > 0 }
                            ...
                            <a href="index.php?page=refund:delete&refund_id={$refund_id}" onclick="return confirmChoice('{t}Are you sure you want to delete this Refund Record?{/t}');"><img src="{$theme_images_dir}icons/delete.gif" alt="" border="0" height="14" width="14" /> {t}Delete{/t}</a>
                        {/if}                        
                    </div>
                {/if}
                ...
                {if $login_usergroup_id == 1 || $login_usergroup_id == 2}
                    <div>
                        ...
                        <a href="index.php?page=company:settings"><img src="{$theme_images_dir}icons/key.png" alt="" border="0" height="14" width="14" /> {t}Settings{/t}</a>
