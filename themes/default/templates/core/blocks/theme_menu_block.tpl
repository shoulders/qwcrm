            ...
            <div style="float: left" id="main_menu" class="sdmenu">
                ...
                <div>
                    ...
                    {if $customer_id > 0 }
                        ...
                        <a href="?page=customer:note_new&customer_id={$customer_id}"><img src="{$theme_images_dir}icons/16x16/email.jpg" alt="" border="0" height="14" width="14" />New Note</a>
                    {/if}        
                </div>
                ...
                {if $login_account_type_id == 1}
                    <div>
                        ...
                        <a href="?page=invoice:labour_rates"><img src="{$theme_images_dir}icons/money.png" alt="" border="0" height="14" width="14" /> {$translate_core_menu_invoice_rates}</a>
