                                                                            ...
                                                                            <table>
                                                                                <tbody align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <select name="employee_status" class="olotd5">
                                                                                                <option value="0" {if $employee_details.EMPLOYEE_STATUS == '0'} selected {/if}>No</option>
                                                                                                <option value="1" {if $employee_details.EMPLOYEE_STATUS == '1'} selected {/if}>Yes</option>
                                                                                            </select>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input id="confirmPassword" name="employee_confirmPassword" class="olotd5" type="password" maxlength="20" onkeyup="checkPasswordsMatch('{$translate_core_theme_passwords_match}', '{$translate_core_theme_passwords_do_not_match}');" onkeydown="onlyPassword(event);">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="3">
                                                                                            ...
                                                                                            <select name="employee_based" class="olotd5">                                                                                                    
                                                                                                <option value="1" {if $employee_details.EMPLOYEE_BASED == 1 } selected{/if}>Office</option>
                                                                                                <option value="2" {if $employee_details.EMPLOYEE_BASED == 2 } selected{/if}>Home</option>
                                                                                                <option value="3" {if $employee_details.EMPLOYEE_BASED == 3 } selected{/if}>OnSite</option>
                                                                                            </select>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
