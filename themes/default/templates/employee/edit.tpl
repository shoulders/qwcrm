                                                            ...
                                                            <td>
                                                                {section name="a" loop=$employee_details}                                                                
                                                                    ...
                                                                    <table width="100%" cellpadding="5" cellspacing="0" border="0" class="olotable">
                                                                                ...
                                                                                <table>
                                                                                    <tbody align="left">
                                                                                        ...
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <select  class="requiredfields" name="type" >
                                                                        ...
                                                                        <tr class="row2"><td class="menuhead" colspan="2">&nbsp;{$translate_employee_phone_numbers}</td>
                                                                        </tr>
                                                                        <tr>
