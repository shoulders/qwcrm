    ...
    <tr>
        <td>
            <table width="700" cellpadding="5" cellspacing="0" border="0">
                <tr>
                    <td class="menuhead2" width="80%">&nbsp;{t}Add New Employee{/t}</td>
                    <td class="menuhead2" width="20%" align="right" valign="middle">                        
                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=tooltip}EMPLOYEE_NEW_HELP_TITLE{/t}</strong></div><hr><div>{t escape=tooltip}EMPLOYEE_NEW_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">
                    </td>
                </tr>                
                <tr>
                    <td class="menutd2">
                                                        ...
                                                        <tr>
                                                            <td>                                                                
                                                                <table class="olotable" width="100%" cellpadding="5" cellspacing="0" border="0">
                                                                        ...
                                                                        <td align="left">
                                                                            <table>
                                                                                <tbody align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="1" align="right"><b>{t}Active{/t}</b></td>
                                                                                        <td>                                                                                                
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input id="confirmPassword" name="employee_confirmPassword" class="olotd5" type="password" maxlength="20" required onkeyup="checkPasswordsMatch('{t}Passwords Match!{/t}', '{t}Passwords Do Not Match!{/t}');" onkeydown="return onlyPassword(event);">
                                                                    ...
                                                                    <tr class="row2">
                                                                        <td class="menuhead" colspan="2">&nbsp;{t}Aaddress{/t}</td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="3">
                                                                            <table>
                                                                                <tbody align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        <td colspan="3">
                                                                                            ...
                                                                                            <select name="employee_based" class="olotd5" value="{$employee_details.EMPLOYEE_BASED}">                                                                                                
                                                                                                <option value="1" selected>{t}Office{/t}</option>
                                                                                                <option value="2">{t}Home{/t}</option>
                                                                                                <option value="3">{t}OnSite{/t}</option>
                                                                                            </select>
                                                                                        </td>
                                                                                    </tr>
                                                                                </tbody>
