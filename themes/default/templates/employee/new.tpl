            ...
            <table width="700" cellpadding="5" cellspacing="0" border="0" >
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">
                        <img src="{$theme_images_dir}icons/16x16/help.gif" alt="" border="0" onMouseOver="ddrivetip('<b>Customer Details</b><hr><p>No help</p>');" onMouseOut="hideddrivetip();">
                    </td>
                </tr>
                <tr>
                                                    ...
                                                    <table width="100%" cellpadding="5" cellspacing="0" border="0" class="olotable">
                                                            ...
                                                            <td colspan="2" align="left">
                                                                <table>
                                                                    <tbody align="left">
                                                                        ...
                                                                        <tr>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_first_name}</strong></td>
                                                                            <td><input name="firstName" type="text" class="olotd5"/></td>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_last_name}</strong></td>
                                                                            <td><input name="lastName" type="text" class="olotd5"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_login_id}</strong></td>
                                                                            <td><input name="login_id" type="text" class="olotd5"/></td>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_password}</strong></td>
                                                                            <td><input name="password" type="password" class="olotd5"/></td>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_password_confirm}</strong></td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <table>
                                                                    <tr>
                                                                        <td><span style="color: #ff0000">*</span><strong>{$translate_employee_home_phone_number}</strong></td>
                                                                        <td><input name="homePhone" type="text" class="olotd5" /></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><strong>{$translate_employee_work_phone_number}</strong></td>
                                                                        <td><input name="workPhone" type="text" class="olotd5"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td><strong>{$translate_employee_mobile_phone_number}</strong></td>
                                                        ...
                                                        <tr>
                                                            <td colspan="2">
                                                                <table>
                                                                    <tbody align="left">
                                                                        <tr>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_address}</strong></td>
                                                                            <td colspan="3"><input size="54" name="address" type="text" class="olotd5"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_city}</strong></td>
                                                                            <td><input name="city" type="text" class="olotd5" value="{$company_city}"/></td>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_state}</strong></td>
                                                                            <td><input name="state" type="text" class="olotd5" value="{$company_state}"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_zip}</strong></td>                        <td colspan="2"><input name="zip" type="text" class="olotd5" value="{$company_zip}"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td>
                                                                                <span style="color: #ff0000">*</span>
                                                        ...
                                                        <tr>
                                                            <td><span style="color: #ff0000">*</span><strong>{$translate_employee_email_address}</strong><input name="email" type="text" class="olotd5"/></td>
                                                            <td></td>
                                                        </tr>
                                                        <tr>
