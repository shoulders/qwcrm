                                                                ...
                                                                <table>
                                                                    <tbody align="left">
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="3"><input class="olotd5" size="60" name="displayName" type="text" maxlength="50" required onkeydown="return onlyAlpha(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right"><b>{$translate_first}</b></td>
                                                                            <td><input class="olotd5" name="firstName" name="firstName" type="text" maxlength="20" onkeydown="return onlyAlpha(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right"><b>{$translate_last}</b></td>
                                                                            <td><input class="olotd5" name="lastName" type="text" maxlength="20" onkeydown="return onlyAlpha(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right"><span style="color: #ff0000"></span><b>{$translate_customer_www}</b></td>
                                                                            <td><input class="olotd5" name="customerWww" size="50" type="url" maxlength="50" placeholder="https://quantumwarp.com" pattern="https?://.+" onkeydown="return onlyURL(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input class="olotd5" name="creditterms" name="creditterms" size="50" type="text" maxlength="50" onkeydown="return onlyAlphaNumeric(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><a><input class="olotd5" value="0.00" name="discount" type="text" maxlength="5" pattern="{literal}\d{0,2}(\.\d{0,2})?{/literal}" required onkeydown="return onlyNumbersPeriod(event);"/><b>%</b></a></td>
                                                                        </tr>                                                              
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                                            ...
                                                            <td colspan="2">
                                                                <table>
                                                                    <tr>
                                                                        ...
                                                                        <td><input class="olotd5" name="homePhone" type="tel" maxlength="20" onkeydown="return onlyPhoneNumber(event);"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="right"><b>{$translate_customer_work}</b></td>
                                                                        <td><input class="olotd5" name="workPhone" type="tel" maxlength="20" onkeydown="return onlyPhoneNumber(event);"/></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td align="right"><b>{$translate_customer_mobile}</b></td>
                                                                        <td><input class="olotd5" name="mobilePhone" type="tel" maxlength="20" onkeydown="return onlyPhoneNumber(event);"/></td>
                                                                    </tr>
                                                                </table>
                                                            </td>
                                                        </tr>
                                                                ...
                                                                <table>
                                                                    <tbody align="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input class="olotd5" name="city" type="text" onkeydown="return onlyAlpha(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right"><b>{$translate_customer_state}</b></td>
                                                                            <td><input class="olotd5" name="state" type="text" onkeydown="return onlyAlpha(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right"><b>{$translate_customer_zip}</b></td>
                                                                            <td colspan="2"><input class="olotd5" name="zip" type="text" onkeydown="return onlyAlphaNumeric(event);"/></td>
                                                                        </tr>
                                                                        <tr>
