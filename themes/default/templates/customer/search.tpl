                                            ...
                                            <td valign="top" nowrap>
                                                <form id="1">
                                                    ...
                                                    <select name="page_no" onChange="go();">
                                                        ...
                                                        {/section}
                                                        <option value="?page=customer%3Aview&name={$name|escape}&submit=submit&page_no={$total_pages}" {if $page_no == $total_pages} selected {/if}>{$translate_page} {$total_pages} {$translate_of} {$total_pages}</option>
                                                    </select>
                                                    {if $next != ''}
                                                    ...
                                                    {section name=i loop=$customer_search_result}
                                                        <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='index.php?page=customer:customer_details&customer_id={$customer_search_result[i].CUSTOMER_ID}&page_title={$customer_search_result[i].CUSTOMER_FIRST_NAME}';" class="row1">
                                                            <td class="olotd4" nowrap>
                                                                <a href="?page=customer:customer_details&customer_id={$customer_search_result[i].CUSTOMER_ID}&page_title={$customer_search_result[i].CUSTOMER_FIRST_NAME}%20{$customer_search_result[i].CUSTOMER_LAST_NAME}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif" alt="" border="0" onMouseOver="ddrivetip('View Customer Details')" onMouseOut="hideddrivetip()"></a>&nbsp;
