                                                ...
                                                <table class="olotable" width="100%" border="0" cellpadding="5" cellspacing="0">
                                                    ...
                                                    {section name=i loop=$search_result}
                                                        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=customer:details&customer_id={$search_result[i].customer_id}';" class="row1">
                                                            ...
                                                            <td class="olotd4" nowrap><img src="{$theme_images_dir}icons/16x16/view.gif" alt="" border="0" onMouseOver="ddrivetip('{$search_result[i].address}<br>{$search_result[i].city}<br>{$search_result[i].state}<br>{$search_result[i].zip}<br>{$search_result[i].country}');" onMouseOut="hideddrivetip();">&nbsp;{$search_result[i].display_name}</td>
