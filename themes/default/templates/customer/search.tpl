                                                    ...
                                                    {section name=i loop=$customer_search_result}
                                                        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=customer:details&customer_id={$customer_search_result[i].CUSTOMER_ID}&page_title={$customer_search_result[i].CUSTOMER_FIRST_NAME}';" class="row1">
                                                            <td class="olotd4" nowrap>
                                                                ...
                                                                <a href="?page=invoice:new&invoice_type=invoice-only&workorder_id=0&customer_id={$customer_search_result[i].CUSTOMER_ID}&page_title=Invoice Only"><img src="{$theme_images_dir}icons/16x16/small_new_invoice_only.gif" alt="" border="0" onMouseOver="ddrivetip('New Invoice Only');" onMouseOut="hideddrivetip();" alt=""></a>
                                                            </td>
