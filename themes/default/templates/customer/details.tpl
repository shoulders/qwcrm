                ...
                <div class="tab_contents_container">
                                                            ...
                                                            <td class="menutd">                                                           
                                                                <table class="olotable" border="0" cellpadding="5" cellspacing="5" width="100%" summary="Customer Contact">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="menutd">{$customer_details[i].DISCOUNT_RATE}%</td>
                                                                    </tr>
                                                                    <tr class="row2">
                                                                        <td class="menutd" colspan="4"></td>
                                                                    </tr>
                    ...
                    <div id="tab_3_contents" class="tab_contents">
                            ...
                            {section name=w loop=$unpaid_invoices}
                                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=invoice:edit&invoice_id={$unpaid_invoices[w].INVOICE_ID}&workorder_id={$unpaid_invoices[w].WORKORDER_ID}&customer_id={$unpaid_invoices[w].CUSTOMER_ID}&page_title={$translate_customer_invoice}'">
                                    ...
                                    <td class="olotd4" align="center">
                                        ...
                                        <a href="?page=workorder:details&workorder_id={$unpaid_invoices[w].WORKORDER_ID}&customer_id={$unpaid_invoices[w].CUSTOMER_ID}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif" alt="" border="0" onMouseOver="ddrivetip('{$translate_customer_view}')" onMouseOut="hideddrivetip()"></a>
                                    </td>
                                </tr>
                            {/section}
                        </table>
                        ...
                        <table class="olotable" width="100%" border="0" cellpadding="3" cellspacing="0" >
                            ...
                            {section name=w loop=$paid_invoices}
                                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=invoice:details&invoice_id={$paid_invoices[w].INVOICE_ID}&customer_id={$paid_invoices[w].CUSTOMER_ID}&page_title={$translate_customer_invoice}'">
                                    <td class="olotd4"><a href="?page=invoice:details&invoice_id={$paid_invoices[w].INVOICE_ID}&customer_id={$paid_invoices[w].CUSTOMER_ID}&page_title={$translate_customer_invoice}">{$paid_invoices[w].INVOICE_ID}</a></td>
                                    <td class="olotd4"><a href="?page=workorder:details&workorder_id={$paid_invoices[w].WORKORDER_ID}&page_title={$translate_customer_work_order_id} {$paid_invoices[w].WORKORDER_ID}">{$paid_invoices[w].WORKORDER_ID}</a></td>
                                    ...
                                    <td class="olotd4" align="center">
                                        ...
                                        <a href="?page=invoice:details&invoice_id={$paid_invoices[w].INVOICE_ID}&customer_id={$paid_invoices[w].CUSTOMER_ID}&page_title={$translate_customer_invoice}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif"  alt="" border="0" onMouseOver="ddrivetip('{$translate_customer_view}')" onMouseOut="hideddrivetip()"></a>
                                    </td>
                                </tr>
                            {/section}
                        </table>
                    ...
                    <div id="tab_5_contents" class="tab_contents">
                            ...
                            {section name=w loop=$unpaid_invoices}
                                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=invoice:edit&workorder_id={$unpaid_invoices[w].WORKORDER_ID}&customer_id={$unpaid_invoices[w].CUSTOMER_ID}&page_title={$translate_customer_invoice}'">
                                    ...
                                    <td class="olotd4" align="center">
                                        ...
                                        <a href="?page=workorder:details&workorder_id={$unpaid_invoices[w].WORK_ORDER_ID}&customer_id={$unpaid_invoices[w].CUSTOMER_ID}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif" alt="" border="0" onMouseOver="ddrivetip('{$translate_customer_view}')" onMouseOut="hideddrivetip()"></a>
                                    </td>
                                </tr>
                            {/section}
                        </table>
                        ...
                        <table class="olotable" width="100%" border="0" cellpadding="3" cellspacing="0" >
                            ...
                            {section name=w loop=$paid_invoices}
                                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=invoice:details&customer_id={$paid_invoices[w].CUSTOMER_ID}&invoice_id={$paid_invoices[w].INVOICE_ID}&page_title={$translate_customer_invoice}'">
                                    <td class="olotd4"><a href="?page=invoice:details&customer_id={$paid_invoices[w].CUSTOMER_ID}&invoice_id={$paid_invoices[w].INVOICE_ID}&page_title={$translate_customer_invoice}">{$paid_invoices[w].INVOICE_ID}</a></td>
                                    <td class="olotd4"><a href="?page=workorder:details&workorder_id={$paid_invoices[w].WORKORDER_ID}&page_title={$translate_customer_work_order_id} {$paid_invoices[w].WORKORDER_ID}">{$paid_invoices[w].WORKORDER_ID}</a></td>
                                    <td class="olotd4">{$paid_invoices[w].INVOICE_DATE|date_format:"$date_format"}</td>
                                    <td class="olotd4">{$currency_sym}{$paid_invoices[w].INVOICE_AMOUNT|string_format:"%.2f"}</td>
                                    <td class="olotd4">{$currency_sym}{$paid_invoices[w].PAID_AMOUNT|string_format:"%.2f"}</td>
                                    ...
                                    <td class="olotd4" align="center">
                                        ...
                                        <a href="?page=invoice:details&customer_id={$paid_invoices[w].CUSTOMER_ID}&invoice_id={$paid_invoices[w].INVOICE_ID}&page_title={$translate_customer_invoice}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif"  alt="" border="0" onMouseOver="ddrivetip('{$translate_customer_view}')" onMouseOut="hideddrivetip()"></a>
                                    </td>
                                </tr>
                            {/section}
                        </table>
