                                                    ...
                                                    {section name=i loop=$expense_search_result}
                                                        ...
                                                        <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='index.php?page=expense:expense_details&expense_id={$expense_search_result[i].EXPENSE_ID}&page_title={$translate_expense_details_title}';" class="row1">
                                                            ...
                                                            <td class="olotd4" nowrap>
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==1}{$translate_expense_type_1}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==2}{$translate_expense_type_2}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==3}{$translate_expense_type_3}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==4}{$translate_expense_type_4}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==5}{$translate_expense_type_5}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==6}{$translate_expense_type_6}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==7}{$translate_expense_type_7}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==8}{$translate_expense_type_8}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==9}{$translate_expense_type_9}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==10}{$translate_expense_type_10}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==11}{$translate_expense_type_11}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==12}{$translate_expense_type_12}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==13}{$translate_expense_type_13}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==14}{$translate_expense_type_14}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==15}{$translate_expense_type_15}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==16}{$translate_expense_type_16}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==17}{$translate_expense_type_17}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==18}{$translate_expense_type_18}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==19}{$translate_expense_type_19}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==20}{$translate_expense_type_20}{/if}
                                                                {if $expense_search_result[i].EXPENSE_TYPE ==21}{$translate_expense_type_21}{/if}
                                                            </td>
                                                            <td class="olotd4" nowrap>
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==1}{$translate_expense_payment_method_1}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==2}{$translate_expense_payment_method_2}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==3}{$translate_expense_payment_method_3}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==4}{$translate_expense_payment_method_4}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==5}{$translate_expense_payment_method_5}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==6}{$translate_expense_payment_method_6}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==7}{$translate_expense_payment_method_7}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==8}{$translate_expense_payment_method_8}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==9}{$translate_expense_payment_method_9}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==10}{$translate_expense_payment_method_10}{/if}
                                                                {if $expense_search_result[i].EXPENSE_PAYMENT_METHOD ==11}{$translate_expense_payment_method_11}{/if}
                                                            </td>
                                                            ...
                                                            <td class="olotd4" nowrap>{if !$expense_search_result[i].EXPENSE_NOTES == ""}
                                                                <img src="{$theme_images_dir}icons/16x16/view.gif" border="0" alt="" onMouseOver="ddrivetip('<b>{$translate_expense_notes}</b><hr><p>{$expense_search_result[i].EXPENSE_NOTES|nl2br|regex_replace:"/[\r\t\n]/":" "}</p>');" onMouseOut="hideddrivetip();">{/if}
                                                            </td>
