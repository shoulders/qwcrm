                        ...
                        <table width="100%" class="olotable" cellpadding="5" cellspacing="0" border="0">
                            <tr>
                                <td width="100%" valign="top">                                    
                                    <form action="index.php?page=user:new" method="post" name="new_user" id="new_user" onsubmit="return confirmPasswordsMatch();"> 
                                                                            ...
                                                                            <table>
                                                                                <tbody align="left">
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><input name="display_name" class="olotd5" value="{$user_details.display_name}" type="text" maxlength="20" required onkeydown="return onlyAlpha(event);"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="right"><strong>{t}First Name{/t}</strong><span style="color: #ff0000">*</span></td>
                                                                                        <td><input name="first_name" class="olotd5" value="{$user_details.first_name}" type="text" maxlength="20" required onkeydown="return onlyAlpha(event);"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                    ...
                                                                                    <tr{if $is_employee} style="display: none;"{/if}>
                                                                                        ...
                                                                                        <td>
                                                                                            {if !$is_employee}
                                                                                                <a href="index.php?page=customer:details&customer_id={$customer_id}">{$customer_display_name}</a>
                                                                            ...
                                                                            <table>
                                                                                <tbody align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><input id="password" name="password" class="olotd5" type="password" maxlength="20" required onkeydown="return onlyPassword(event);"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="right"><strong>{t}Confirm Password{/t}</strong></td>
                                                                                        <td>
                                                                                            <input id="confirmPassword" name="confirmPassword" class="olotd5" type="password" maxlength="20" onkeyup="checkPasswordsMatch('{t}Passwords Match!{/t}', '{t}Passwords Do Not Match!{/t}');" onkeydown="onlyPassword(event);">
