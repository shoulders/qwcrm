                            ...
                            <tr>
                                <td width="100%" valign="top">                                       
                                    ...
                                    <div id="tabs_container">
                                        ...
                                        <!-- The Actual Tabs -->
                                        <ul class="tabs">
                                            <li class="active"><a href="#" rel="#tab_1_contents" class="tab"><img src="{$theme_images_dir}icons/workorders.gif" alt="" border="0" height="14" width="14" />&nbsp;{t}User Details{/t}</a></li>
