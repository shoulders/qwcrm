                                            ...
                                            <tr>
                                                ...
                                                <td class="menuhead2" width="20%" align="right" valign="middle">                                               
                                                    <a href="index.php?page=workorder:print&workorder_id={$workorder_id}&print_content=technician_workorder_slip&print_type=print_html&theme=off&page_title=CHANGE THIS TITLE" target="_blank">                                                    
                                                        <img src="{$theme_images_dir}icons/print.gif" alt="Print Works Order" border="0" height="14" width="14" onMouseOver="ddrivetip('{$translate_workorder_print_work_order} <br> Tech translate me');" onMouseOut="hideddrivetip();" />
                                                    </a>
                                                    <a href="index.php?page=workorder:print&workorder_id={$workorder_id}&print_content=customer_workorder_slip&print_type=print_html&theme=off&page_title=CHANGE THIS TITLE" target="_blank">                                                    
                                                        <img src="{$theme_images_dir}icons/print.gif" alt="Print Works Order" border="0" height="14" width="14" onMouseOver="ddrivetip('{$translate_workorder_print_work_order} <br> Customer translate me');" onMouseOut="hideddrivetip();" />                                                        
                                                    </a>
