...
<table width="900" border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse;">
    <tr bgcolor="#999999">
        ...
        <td valign="top" align="center">            
            ...
            {$translate_workorder_work_order_id} {$single_workorder.WORK_ORDER_ID}
        </td>
            ...
            <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                    <td>
                        ...
                        <p>
                            <b>{$translate_workorder_contact}: </b>{$single_workorder.CUSTOMER_FIRST_NAME} {$single_workorder.CUSTOMER_LAST_NAME}<br />
                            <b>{$translate_workorder_primary_phone}: </b>{$single_workorder.CUSTOMER_PHONE}<br>
                            <b>{$translate_workorder_work}: </b>{$single_workorder.CUSTOMER_WORK_PHONE}<br>
                            <b>{$translate_workorder_mobile}: </b>{$single_workorder.CUSTOMER_MOBILE_PHONE}<br>
                            <b>{$translate_workorder_email}: </b>{$single_workorder.CUSTOMER_EMAIL}<br>                            
                        </p>
                        <p>
                            ...
                            {if $single_workorder.CUSTOMER_TYPE == '5'}{$translate_workorder_customer_type_4}{/if} 
                            {if $single_workorder.CUSTOMER_TYPE == '6'}{$translate_workorder_customer_type_4}{/if} 
                            {if $single_workorder.CUSTOMER_TYPE == '7'}{$translate_workorder_customer_type_4}{/if}
                            {if $single_workorder.CUSTOMER_TYPE == '8'}{$translate_workorder_customer_type_4}{/if}
                            {if $single_workorder.CUSTOMER_TYPE == '9'}{$translate_workorder_customer_type_4}{/if} 
                            {if $single_workorder.CUSTOMER_TYPE == '10'}{$translate_workorder_customer_type_4}{/if}                            
                        </p>
                    </td>
                </tr>
            </table>            
            ...
            <table cellpadding="4" cellspacing="0" border="0">                                  
                <tr>
                    <td>
                        ...
                        <p>
                            <b>{$translate_workorder_phone}: </b>{$single_workorder.EMPLOYEE_WORK_PHONE}<br>                        
                            <b>{$translate_workorder_mobile}: </b>{$company_details.COMPANY_MOBILE}<br>
                            <b>{$translate_workorder_fax}: </b>{$company_details.COMPANY_FAX}<br>
                            <b>{$translate_workorder_website}: </b>{$company_details.COMPANY_WWW}<br>   
                            <b>{$translate_workorder_email}: </b>{$company_details.COMPANY_EMAIL}
                        </p>
                    </td>
                </tr>                                  
            </table>    
