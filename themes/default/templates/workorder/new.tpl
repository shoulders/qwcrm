                ...
                <div class="tab_contents_container">
                    ...
                    <div id="tab_1_contents" class="tab_contents tab_contents_active">                        
                        <table width="700" cellpadding="5" cellspacing="0" border="0">
                            <tr>                                
                                <td class="menuhead2" width="80%">{$translate_workorder_new} {$translate_workorder_work_order} {$translate_workorder_for} {$customer_details.CUSTOMER_DISPLAY_NAME}</td>
                                <td class="menuhead2" width="20%" align="right" valign="middle">
                                    <a>
                                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<b>{$translate_workorder_new_help_title|nl2br|regex_replace:"/[\r\t\n]/":" "}</b><hr><p>{$translate_workorder_new_help_content|nl2br|regex_replace:"/[\r\t\n]/":" "}</p>');" onMouseOut="hideddrivetip();">                                        
                                    </a>
                                </td>
                            </tr>
                            <tr>
                    ...
                    <div id="tab_2_contents" class="tab_contents">                                        
                        <table class="olotable" border="0" cellpadding="2" cellspacing="0" width="80%" summary="Customer Contact">
                            ...
                            <tr>
                                ...
                                <td class="menutd">
                                    {if $customer_details.CUSTOMER_TYPE =='1'}{$translate_workorder_customer_type_1}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='2'}{$translate_workorder_customer_type_2}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='3'}{$translate_workorder_customer_type_3}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='4'}{$translate_workorder_customer_type_4}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='5'}{$translate_workorder_customer_type_5}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='6'}{$translate_workorder_customer_type_6}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='7'}{$translate_workorder_customer_type_7}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='8'}{$translate_workorder_customer_type_8}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='9'}{$translate_workorder_customer_type_9}{/if}
                                    {if $customer_details.CUSTOMER_TYPE =='10'}{$translate_workorder_customer_type_10}{/if}
                                </td>
                                <td class="menutd"></td>
                                <td class="menutd"></td>
                            </tr>
