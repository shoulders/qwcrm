                                            ...
                                            <td width="100%" valign="top" >                                               
                                                ...
                                                {/literal}
                                                    ...
                                                    <table class="olotable" width="100%" border="0" summary="Work order display">
                                                        ...
                                                        <tr>
                                                            <td class="olotd"><textarea class="olotd4" rows="15" cols="70" mce_editable="true" name="workorder_comments"></textarea></td>
                                                        </tr>
                                                    </table>
                                                    <br>
                                                    <input type="submit" name="submit" value="{$translate_workorder_submit}"/>
                                                    ...
                                                    <table class="olotable" width="100%" border="0" summary="Work order display">
                                                        ...
                                                        <tr>
                                                            <td class="olotd"><textarea class="olotd4" rows="15" cols="70" mce_editable="true" name="workorder_note"></textarea></td>
                                                        </tr>
                                                    </table>
                                                    <br>
                                                    <input type="submit" name="submit" value="{$translate_workorder_submit}"/>
