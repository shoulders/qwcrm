        ...
        <td class="olohead"><b>{$translate_workorder_action}</b></td>
                ...
                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=workorder:view&wo_id={$awaiting.WORK_ORDER_ID}&customer_id={$awaiting.CUSTOMER_ID}&page_title={$translate_workorder_page_title} {$awaiting.WORK_ORDER_ID}';" class="row1">
                    ...
                    <td class="olotd4" nowrap>
                        <img src="{$theme_images_dir}icons/16x16/view.gif" border="0" onMouseOver="ddrivetip('<b><center>Contact Info</b></center><hr><b>Phone: </b>{$awaiting.CUSTOMER_PHONE}<br> <b>Work: </b>{$awaiting.CUSTOMER_WORK_PHONE}<br><b>Moile: </b>{$awaiting.CUSTOMER_MOBILE_PHONE}<br><br>{$awaiting.CUSTOMER_ADDRESS}<br>{$awaiting.CUSTOMER_CITY}, {$awaiting.CUSTOMER_STATE}<br>{$awaiting.CUSTOMER_ZIP}')" onMouseOut="hideddrivetip()">
                    ...
                    {else}
                        <img src="{$theme_images_dir}icons/16x16/view.gif" border="0" onMouseOver="ddrivetip('<center><b>Contact</b></center><hr><b>Work: </b>{$awaiting.EMPLOYEE_WORK_PHONE}<br><b>Mobile: </b>{$awaiting.EMPLOYEE_MOBILE_PHONE}<br><b>Home: </b>{$awaiting.EMPLOYEE_HOME_PHONE}')"onMouseOut="hideddrivetip()"> 
                    ...
                    <td class="olotd4" align="center" nowrap>
                        <a href="?page=workorder:print&wo_id={$awaiting.WORK_ORDER_ID}&customer_id={$awaiting.CUSTOMER_ID}&page_title=$translate_workorder_print_title} {$awaiting.WORK_ORDER_ID}&escape=1"><img src="{$theme_images_dir}icons/16x16/fileprint.gif" border="0" onMouseOver="ddrivetip('Print The Work Order')" onMouseOut="hideddrivetip()"></a>
                        <a href="?page=workorder:view&wo_id={$awaiting.WORK_ORDER_ID}&customer_id={$awaiting.CUSTOMER_ID}&page_title={$translate_workorder_page_title} {$awaiting.WORK_ORDER_ID}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif"  border="0" onMouseOver="ddrivetip('View The Work Order')" onMouseOut="hideddrivetip()"></a>                                        
                    </td>
                </tr>
                {else}
                <tr>
