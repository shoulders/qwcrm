    ...
    {section name=u loop=$unassigned_workorders}      
        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=workorder:details&workorder_id={$unassigned_workorders[u].workorder_id}&customer_id={$unassigned_workorders[u].customer_id}';" class="row1">
            ...
            <td class="olotd4" align="center">
                {if $unassigned_workorders[u].workorder_status == '1'}{t}WORKORDER_STATUS_1{/t}{/if}
                {if $unassigned_workorders[u].workorder_status == '2'}{t}WORKORDER_STATUS_2{/t}{/if}
                {if $unassigned_workorders[u].workorder_status == '3'}{t}WORKORDER_STATUS_3{/t}{/if}
                {if $unassigned_workorders[u].workorder_status == '4'}{t}WORKORDER_STATUS_4{/t}{/if}
                {if $unassigned_workorders[u].workorder_status == '5'}{t}WORKORDER_STATUS_5{/t}{/if}
                {if $unassigned_workorders[u].workorder_status == '6'}{t}WORKORDER_STATUS_6{/t}{/if}
                {if $unassigned_workorders[u].workorder_status == '7'}{t}WORKORDER_STATUS_7{/t}{/if}                
            </td>
