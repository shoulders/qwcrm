...
<table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
    ...
    {section name=p loop=$awaiting_workorders}        
        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='?page=workorder:details&workorder_id={$awaiting_workorders[p].WORK_ORDER_ID}&customer_id={$awaiting_workorders[p].CUSTOMER_ID}&page_title={$translate_workorder_work_order_id} {$awaiting_workorders[p].WORK_ORDER_ID}';" class="row1">

            <!-- ID -->
            <td class="olotd4"><a href="?page=workorder:details&workorder_id={$awaiting_workorders[p].WORK_ORDER_ID}&customer_id={$awaiting_workorders[p].CUSTOMER_ID}&page_title={$translate_workorder_work_order_id} {$awaiting_workorders[p].WORK_ORDER_ID}">{$awaiting_workorders[p].WORK_ORDER_ID}</a></td>
            ...
            <td class="olotd4" nowrap>
                ...
                <a class="link1" href="?page=customer:details&customer_id={$awaiting_workorders[p].CUSTOMER_ID}&page_title={$awaiting_workorders[p].CUSTOMER_DISPLAY_NAME}">{$awaiting_workorders[p].CUSTOMER_DISPLAY_NAME}</a>
            </td>
            ...
            <td class="olotd4" nowrap>
                ...
                {else}
                    ...
                    <a class="link1" href="?page=employee:details&employee_id={$awaiting_workorders[p].EMPLOYEE_ID}&page_title={$awaiting_workorders[p].EMPLOYEE_DISPLAY_NAME}">{$awaiting_workorders[p].EMPLOYEE_DISPLAY_NAME}</a>
                {/if}
            </td>

            <!-- Action -->
            <td class="olotd4" align="center" nowrap>
                <a href="?page=workorder:print&workorder_id={$awaiting_workorders[p].WORK_ORDER_ID}&customer_id={$awaiting_workorders[p].CUSTOMER_ID}&page_title=$translate_workorder_print_work_order_id} {$awaiting_workorders[p].WORK_ORDER_ID}&theme=off">
                ...
                <a href="?page=workorder:details&workorder_id={$awaiting_workorders[p].WORK_ORDER_ID}&customer_id={$awaiting_workorders[p].CUSTOMER_ID}&page_title={$translate_workorder_work_order_id} {$awaiting_workorders[p].WORK_ORDER_ID}">
