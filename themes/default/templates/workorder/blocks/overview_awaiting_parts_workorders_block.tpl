    ...
    {section name=p loop=$awaiting_workorders}        
        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=workorder:details&workorder_id={$awaiting_workorders[p].workorder_id}&customer_id={$awaiting_workorders[p].customer_id}';" class="row1">
            ...
            <td class="olotd4" align="center" nowrap>
                <a href="index.php?page=workorder:print&workorder_id={$awaiting_workorders[p].workorder_id}&print_content=technician_workorder_slip&print_type=print_html&theme=print" target="_blank">                                                    
                ...
                <a href="index.php?page=workorder:print&workorder_id={$awaiting_workorders[p].workorder_id}&print_content=technician_job_sheet&print_type=print_html&theme=print" target="_blank">                                                    
                ...
                <a href="index.php?page=workorder:print&workorder_id={$awaiting_workorders[p].workorder_id}&print_content=customer_workorder_slip&print_type=print_html&theme=print" target="_blank">                                                    
