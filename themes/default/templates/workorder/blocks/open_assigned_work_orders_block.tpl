    ...
    <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='?page=workorder:details&wo_id={$assigned.WORK_ORDER_ID}&customer_id={$assigned.CUSTOMER_ID}&page_title={$translate_workorder_work_order_id} {$assigned.WORK_ORDER_ID}';" class="row1">
        ...
        <td class="olotd4" nowrap>
            <img src="{$theme_images_dir}icons/16x16/view.gif" border="0"
                 onMouseOver="ddrivetip('<b><center>{$translate_workorder_contact_info_tooltip_title}</b></center><hr><b>{$translate_workorder_phone}: </b>{$assigned.CUSTOMER_PHONE}<br> <b>{$translate_workorder_fax}: </b>{$assigned.CUSTOMER_WORK_PHONE}<br><b>{$translate_workorder_mobile}: </b>{$assigned.CUSTOMER_MOBILE_PHONE}<br><br>{$assigned.CUSTOMER_ADDRESS}<br>{$assigned.CUSTOMER_CITY}, {$assigned.CUSTOMER_STATE}<br>{$assigned.CUSTOMER_ZIP}');"
