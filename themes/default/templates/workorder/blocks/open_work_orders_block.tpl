                ...
                <tr>
                    ...
                    <td width="33%" align="center" class="button">
                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" 
                            onMouseOver="ddrivetip('<b>{$translate_workorder_open_work_orders_block_help_title}</b><hr><p>{$translate_workorder_open_work_orders_block_help_content}</p>');" 
    ...
    <tr>
        <td colspan="2">
            <table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
                ...
                {else}
                <tr>
                    <td colspan="7" class="error">{$translate_workorder_there_are_no_open_work_orders}</td>
                </tr>
                {/if}
                {/foreach}
            </table>
