            ...
            <table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
                ...
                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=workorder:view&wo_id={$open_workorders.WORK_ORDER_ID}&customer_id={$open_workorders.CUSTOMER_ID}&page_title=Work Order ID {$open_workorders.WORK_ORDER_ID}';" class="row1">
                    ...
                    <td class="olotd4" align="center" nowrap>
                        ...
                        <a href="?page=workorder:view&wo_id={$open_workorders.WORK_ORDER_ID}&customer_id={$open_workorders.CUSTOMER_ID}&page_title=Work Order ID {$open_workorders.WORK_ORDER_ID}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif"  border="0" onMouseOver="ddrivetip('View The Work Order')" onMouseOut="hideddrivetip()"></a>                                            
                    </td>
                </tr>
                {/foreach}
            </table>
