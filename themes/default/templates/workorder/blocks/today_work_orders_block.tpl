                ...
                <tr>
                    ...
                    <td width="33%" align="center" class="button">
                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" 
                            onMouseOver="ddrivetip('<b>{$translate_workorder_today_work_orders_block_help_title}</b><hr><p>{$translate_workorder_today_work_orders_block_help_content}</p>');" 
    ...
    <tr>
        <td colspan="2">
            <table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
                ...
                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=workorder:view&wo_id={$open_workorders.WORK_ORDER_ID}&customer_id={$open_workorders.CUSTOMER_ID}&page_title={$translate_workorder_id} {$open_workorders.WORK_ORDER_ID}';" class="row1">
                    ...
                    <td class="olotd4" nowrap>
                        <img src="{$theme_images_dir}icons/16x16/view.gif" border="0"
                             onMouseOver="ddrivetip('<center><b>{$translate_workorder_contact_info}</b></center><hr><b>{$translate_workorder_work}: </b>{$open_workorders.EMPLOYEE_WORK_PHONE}<br><b>{$translate_workorder_mobile}: </b>{$open_workorders.EMPLOYEE_MOBILE_PHONE}<br><b>{$translate_workorder_home}: </b>{$open_workorders.EMPLOYEE_HOME_PHONE}');"
                             onMouseOut="hideddrivetip();"> 
