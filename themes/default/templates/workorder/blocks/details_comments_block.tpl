                            ...
                            <tr>
                                <td width="33%" align="right">
                                    {if $single_workorder.WORK_ORDER_STATUS != 6}
                                        <a href="index.php?page=workorder:details_edit_comments&workorder_id={$single_workorder.WORK_ORDER_ID}&page_title={$translate_workorder_details_edit_comments_title}">
