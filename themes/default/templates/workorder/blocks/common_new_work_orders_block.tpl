<!-- common_new_work_orders_block.tpl - Display New Work Orders (Work Orders - Open Page) -->
    ...
    <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='?page=workorder:details&wo_id={$new.WORK_ORDER_ID}&customer_id={$new.CUSTOMER_ID}&page_title={$translate_workorder_page_title} {$new.WORK_ORDER_ID}';" class="row1">
        ...
        <td class="olotd4" nowrap>
            <img src="{$theme_images_dir}icons/16x16/view.gif" border="0"
                 onMouseOver="ddrivetip('<b><center>{$translate_workorder_closed_contact_info}</b></center><hr><b>{$translate_workorder_phone}: </b>{$new.CUSTOMER_PHONE}<br> <b>{$translate_workorder_work}: </b>{$new.CUSTOMER_WORK_PHONE}<br><b>{$translate_workorder_mobile}: </b>{$new.CUSTOMER_MOBILE_PHONE}<br><b>{$translate_workorder_address}</b><br>{$new.CUSTOMER_ADDRESS}<br>{$new.CUSTOMER_CITY}, {$new.CUSTOMER_STATE}<br>{$new.CUSTOMER_ZIP}');"
        ...
        {else}
            <img src="{$theme_images_dir}icons/16x16/view.gif" border="0"
                 onMouseOver="ddrivetip('<center><b>{$translate_workorder_closed_contact_info}</b></center><hr><b>{$translate_workorder_work}: </b>{$new.EMPLOYEE_WORK_PHONE}<br><b>{$translate_workorder_mobile}: </b>{$new.EMPLOYEE_MOBILE_PHONE}<br><b>{$translate_workorder_home}: </b>{$new.EMPLOYEE_HOME_PHONE}');"
                 onMouseOut="hideddrivetip();"> 
        ...
        <td class="olotd4" align="center" nowrap>
            ...
            <a href="?page=workorder:details&wo_id={$new.WORK_ORDER_ID}&customer_id={$new.CUSTOMER_ID}&page_title={$translate_workorder_page_title} {$new.WORK_ORDER_ID}">
