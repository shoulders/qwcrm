        ...
        {if $new.WORK_ORDER_ID > 0}
            <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='?page=workorder:details&workorder_id={$new.WORK_ORDER_ID}&customer_id={$new.CUSTOMER_ID}&page_title={$translate_workorder_work_order_id} {$new.WORK_ORDER_ID}';" class="row1">
                ...
                <td class="olotd4" nowrap>
                    ...
                    <a class="link1" href="?page=customer:details&customer_id={$new.CUSTOMER_ID}&page_title={$new.CUSTOMER_DISPLAY_NAME}">{$new.CUSTOMER_DISPLAY_NAME}</a>
                </td>
                ...
                <td class="olotd4" nowrap>
                    ...
                    {else}
                        ...
                        <a class="link1" href="?page=employee:details&employee_id={$new.EMPLOYEE_ID}&page_title={$new.EMPLOYEE_DISPLAY_NAME}">{$new.EMPLOYEE_DISPLAY_NAME}</a>
                    {/if}
                </td>
