                ...
                <tr>
                    <td>                        
                        {if $single_workorder.WORK_ORDER_CLOSE_BY != "" }
                            <p>
                                <b>{$translate_workorder_closed_by}: </b>{$single_workorder.EMPLOYEE_DISPLAY_NAME}<br>
                                <b>{$translate_workorder_date}: </b>{$single_workorder.WORK_ORDER_CLOSE_DATE|date_format:$date_format}<br>
                            </p>
                        {/if}
