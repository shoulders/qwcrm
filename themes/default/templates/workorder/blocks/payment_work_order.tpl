            ...
            <table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
                ...
                <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='?page=workorder:view&wo_id={$payment.WORK_ORDER_ID}&customer_id={$payment.CUSTOMER_ID}&page_title={$translate_workorder_page_title}  {$payment.WORK_ORDER_ID}';" class="row1">
                    ...
                    <td class="olotd4" nowrap>
                        <img src="{$theme_images_dir}icons/16x16/view.gif" border="0" onMouseOver="ddrivetip('<b><center>Contact Info</b></center><hr><b>Phone: </b>{$payment.CUSTOMER_PHONE}<br> <b>Work: </b>{$payment.CUSTOMER_WORK_PHONE}<br><b>Moile: </b>{$payment.CUSTOMER_MOBILE_PHONE}<br><br>{$payment.CUSTOMER_ADDRESS}<br>{$payment.CUSTOMER_CITY}, {$payment.CUSTOMER_STATE}<br>{$payment.CUSTOMER_ZIP}')" onMouseOut="hideddrivetip()">
                    ...
                    {else}
                        <img src="{$theme_images_dir}icons/16x16/view.gif" border="0" onMouseOver="ddrivetip('<center><b>Contact</b></center><hr><b>Work: </b>{$payment.EMPLOYEE_WORK_PHONE}<br><b>Mobile: </b>{$payment.EMPLOYEE_MOBILE_PHONE}<br><b>Home: </b>{$payment.EMPLOYEE_HOME_PHONE}')" onMouseOut="hideddrivetip()"> 
                    ...
                    <td class="olotd4" align="center" nowrap>
                        <a href="?page=workorder:print&wo_id={$payment.WORK_ORDER_ID}&customer_id={$payment.CUSTOMER_ID}&page_title={$translate_workorder_print_title} {$payment.WORK_ORDER_ID}&escape=1" ><img src="{$theme_images_dir}icons/16x16/fileprint.gif" border="0" onMouseOver="ddrivetip('Print The Work Order')" onMouseOut="hideddrivetip()"></a>
                        <a href="?page=workorder:view&wo_id={$payment.WORK_ORDER_ID}&customer_id={$payment.CUSTOMER_ID}&page_title={$translate_workorder_page_title} {$payment.WORK_ORDER_ID}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif"  border="0" onMouseOver="ddrivetip('View The Work Order')" onMouseOut="hideddrivetip()"></a>                                        
                    </td>
                </tr>
                {else}
                    <tr>
