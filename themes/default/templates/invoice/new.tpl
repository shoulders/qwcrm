                                        ...
                                        {if $wo_status == '9' || $workorder_id == '0'}
                                            <p>
                                                ...
                                                {if $invoice.INVOICE_AMOUNT > 0 }
                                                    ...
                                                    <button type="button" name="{$translate_invoice_bill_customer}" onClick="location.href='?page=payment:new&invoice_id={$invoice.INVOICE_ID}';">sssss{$translate_invoice_bill_customer}</button>
