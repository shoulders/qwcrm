                                            ...
                                            <td valign="top" colspan="2">
                                                <table class="olotable" width="100%" border="0" cellpadding="5" cellspacing="0">
                                                    ...
                                                    {section name=q loop=$invoice}
                                                        <tr onmouseover="this.className='row2'" onmouseout="this.className='row1'" onDblClick="window.location='index.php?page=invoice:edit&invoice_id={$invoice[q].INVOICE_ID}&workorder_id={$invoice[q].WORKORDER_ID}&page_title={$translate_invoice_invoice}&customer_id={$invoice[q].CUSTOMER_ID}';" class="row1">
                                                            <td class="olotd4" nowrap><a href="index.php?page=invoice:edit&invoice_id={$invoice[q].INVOICE_ID}&workorder_id={$invoice[q].WORKORDER_ID}&page_title={$translate_invoice_invoice}&customer_id={$invoice[q].CUSTOMER_ID}">{$invoice[q].INVOICE_ID}</a></td>
