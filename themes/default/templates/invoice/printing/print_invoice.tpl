...
<body>
        ...
        <tr>
            ...
            <td colspan="1" valign="top">
                <table width="540" border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;">
                    ...
                    {if $active_payment_system_methods.cheque_active != '1' && $active_payment_system_methods.direct_deposit_active != '1' && $active_payment_system_methods.direct_deposit_active != '1'}
                        <tr>
    ...
    <table width="750" border="0" cellpadding="3" cellspacing="0" style="border-collapse: collapse;">
        ...
        {/if}
        {if $payment_details.tax_enabled && $company_details.vat_number != ''}}
            <tr>
