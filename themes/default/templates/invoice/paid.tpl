                                                ...
                                                <table class="olotable" width="100%" border="0" cellpadding="5" cellspacing="0">
                                                    ...
                                                    {section name=q loop=$invoices}                                            
                                                        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=invoice:details&invoice_id={$invoices[q].INVOICE_ID}';" class="row1">
                                                            <td class="olotd4" nowrap><a href="?page=invoice:details&invoice_id={$invoices[q].INVOICE_ID}">{$invoices[q].INVOICE_ID}</a></td>
                                                            ...
                                                            <td class="olotd4" nowrap><a href="?page=workorder:details&workorder_id={$invoices[q].WORKORDER_ID}&workorder_id={$workorder_id}&page_title={$translate_invoice_workorder_id}{$invoices[q].WORKORDER_ID}">{$invoices[q].WORKORDER_ID}</a></td>
                                                            <td class="olotd4" nowrap><img src="{$theme_images_dir}icons/16x16/view.gif" alt="" border="0" onMouseOver="ddrivetip('<b>Work: </b>{$invoices[q].EMPLOYEE_WORK_PHONE}<br><b>Mobile: </b>{$invoices[q].EMPLOYEE_MOBILE_PHONE}<br><b>Home: </b>{$invoices[q].EMPLOYEE_HOME_PHONE}');" onMouseOut="hideddrivetip();"><a href="?page=employee:details&employee_id={$invoices[q].EMPLOYEE_ID}&page_title={$invoices[q].EMPLOYEE_DISPLAY_NAME}">{$invoices[q].EMPLOYEE_DISPLAY_NAME}</a></td>
