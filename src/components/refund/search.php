...
if(isset(\CMSApplication::$VAR['submit'])) {
    ...
    $this->app->system->page->force_page('refund', 'search', \CMSApplication::$VAR, 'get');
...
$this->app->smarty->assign('display_refunds',          $this->app->components->refund->getRecords('refund_id', 'DESC', true, '25', \CMSApplication::$VAR['page_no'], \CMSApplication::$VAR['search_category'], \CMSApplication::$VAR['search_term'], \CMSApplication::$VAR['filter_type'], \CMSApplication::$VAR['filter_status'])   );