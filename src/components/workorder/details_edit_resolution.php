...
if(isset($VAR['submit'])) {
    ...
    if($VAR['submit'] == 'submitchangesonly') {
        update_workorder_resolution($db, $VAR['workorder_id'], $VAR['resolution']);
    ...
    if($VAR['submit'] == 'closewithoutinvoice') {
        close_workorder_without_invoice($db, $VAR['workorder_id'], $VAR['resolution']);
    ...
    if($VAR['submit'] == 'closewithinvoice') {
        close_workorder_with_invoice($db, $VAR['workorder_id'], $VAR['resolution']);
...
// Build the page
$smarty->assign('resolution', get_workorder_details($db, $VAR['workorder_id'], 'resolution'));
