...
$this->app->smarty->assign('selected_date',            $this->app->system->general->timestampToCalendarFormat($this->app->system->general->yearMonthDayToTimestamp(\CMSApplication::$VAR['start_year'], \CMSApplication::$VAR['start_month'], \CMSApplication::$VAR['start_day']))    );
$this->app->smarty->assign('employees',                $this->app->components->user->getActiveUsers('employees')                                                                                                    );
$this->app->smarty->assign('current_schedule_date',    $this->app->system->general->yearMonthDayToTimestamp(\CMSApplication::$VAR['start_year'], \CMSApplication::$VAR['start_month'], \CMSApplication::$VAR['start_day'])                                  );
