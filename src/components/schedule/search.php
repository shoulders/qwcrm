...
$this->app->smarty->assign('display_schedules', $this->app->components->schedule->getRecords('schedule_id', 'DESC', true, '25', \CMSApplication::$VAR['page_no'], \CMSApplication::$VAR['search_category'], \CMSApplication::$VAR['search_term']), \CMSApplication::$VAR['filter_status']   );