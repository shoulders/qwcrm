...
// If new schedule form is intially loaded, load schedule item from the database and assign
    ...
    $schedule_details['start_date']     = $this->app->system->general->yearMonthDayToDate(\CMSApplication::$VAR['start_year'], \CMSApplication::$VAR['start_month'], \CMSApplication::$VAR['start_day']);
    $schedule_details['start_time']     = \CMSApplication::$VAR['start_time'];
    $schedule_details['end_date']       = $this->app->system->general->yearMonthDayToDate(\CMSApplication::$VAR['start_year'], \CMSApplication::$VAR['start_month'], \CMSApplication::$VAR['start_day']);
