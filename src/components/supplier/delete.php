...
$this->app->components->supplier->delete_supplier(\CMSApplication::$VAR['supplier_id']);

// Load the supplier search page
$this->app->system->general->force_page('supplier', 'search', 'msg_success='._gettext("Supplier deleted successfully."));
