...
$allowed_to_unapprove = $this->app->components->creditnote->checkRecordAllowsUnapprove(\CMSApplication::$VAR['creditnote_id']);
...
// Unapprove
if(isset(\CMSApplication::$VAR['unapprove_creditnote']) && $allowed_to_unapprove){
    $this->app->components->creditnote->updateStatus(\CMSApplication::$VAR['creditnote_id'], 'draft');
    $this->app->system->page->forcePage('creditnote', 'status&creditnote_id='.\CMSApplication::$VAR['creditnote_id']);
}
