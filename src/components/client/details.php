...
$smarty->assign('voucher_stats',            get_vouchers_stats('all', null, null, null, null, $VAR['client_id'])  );
...
$smarty->assign('payment_stats',            get_payments_stats('all', null, null, null, null, $VAR['client_id'])   );
...
$smarty->assign('refund_stats',             get_refunds_stats('all', null, null, null, null, $VAR['client_id'])   );
