...
$this->app->smarty->assign('workorders_open',          $this->app->components->workorder->getRecords('workorder_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, 'open', null, \CMSApplication::$VAR['client_id'])          );
$this->app->smarty->assign('workorders_closed',        $this->app->components->workorder->getRecords('workorder_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, 'closed', null, \CMSApplication::$VAR['client_id'])       );
...
$this->app->smarty->assign('invoices_open',            $this->app->components->invoice->getRecords('invoice_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, 'open', null, \CMSApplication::$VAR['client_id'])           );
$this->app->smarty->assign('invoices_closed',          $this->app->components->invoice->getRecords('invoice_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, 'closed', null, \CMSApplication::$VAR['client_id'])            );
...
$this->app->smarty->assign('vouchers_purchased',      $this->app->components->voucher->getRecords('voucher_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, null, null, \CMSApplication::$VAR['client_id'])              );
$this->app->smarty->assign('vouchers_claimed',        $this->app->components->voucher->getRecords('voucher_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, 'redeemed', null, null, null, null, \CMSApplication::$VAR['client_id'])        );
...
$this->app->smarty->assign('payments_received',        $this->app->components->payment->getRecords('payment_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, 'received', null, null, null, \CMSApplication::$VAR['client_id'])        );
$this->app->smarty->assign('payments_sent',            $this->app->components->payment->getRecords('payment_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, 'sent', null, null, null, \CMSApplication::$VAR['client_id'])        );
...
$this->app->smarty->assign('display_refunds',         $this->app->components->refund->getRecords('refund_id', 'DESC', false, '25', \CMSApplication::$VAR['page_no'], null, null, null, null, null, \CMSApplication::$VAR['client_id'])        );
