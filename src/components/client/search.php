...
if(isset(\CMSApplication::$VAR['submit'])) {
    ...
    $this->app->system->general->force_page('client', 'search', \CMSApplication::$VAR, 'get');
...
$this->app->smarty->assign('display_clients',    $this->app->components->client->display_clients('client_id', 'DESC', true, '25', \CMSApplication::$VAR['page_no'], \CMSApplication::$VAR['search_category'], \CMSApplication::$VAR['search_term'], \CMSApplication::$VAR['filter_type'], \CMSApplication::$VAR['filter_status'])   );