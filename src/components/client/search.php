...
if(isset(\CMSApplication::$VAR['submit'])) {
    ...
    force_page('client', 'search', \CMSApplication::$VAR, 'get');
...
$smarty->assign('display_clients',    display_clients('client_id', 'DESC', true, '25', \CMSApplication::$VAR['page_no'], \CMSApplication::$VAR['search_category'], \CMSApplication::$VAR['search_term'], \CMSApplication::$VAR['filter_type'], \CMSApplication::$VAR['filter_status'])   );