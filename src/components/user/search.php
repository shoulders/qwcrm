...
$this->app->smarty->assign('display_users',     $this->app->components->user->getRecords('user_id', 'DESC', 25, true, \CMSApplication::$VAR['page_no'], \CMSApplication::$VAR['search_category'], \CMSApplication::$VAR['search_term'], \CMSApplication::$VAR['filter_usergroup'], \CMSApplication::$VAR['filter_usertype'], \CMSApplication::$VAR['filter_status'])    );