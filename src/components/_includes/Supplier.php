...
class Supplier extends Components {
    ...
    public function getRecords($order_by, $direction, $use_pages = false, $records_per_page = 0, $page_no = null, $search_category = 'supplier_id', $search_term = null, $type = null, $status = null) {
