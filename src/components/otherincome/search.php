...
if(isset(\CMSApplication::$VAR['submit'])) {
    ...
    // Log activity
    $logMessage = _gettext("A search of other incomes has been performed with the search term").' `'.\CMSApplication::$VAR['search_term'].'` '.'in the category'.' `'.\CMSApplication::$VAR['search_category'].'`.';
    ...
    $this->app->system->page->forcePage('otherincome', 'search', \CMSApplication::$VAR, 'get');
...
$this->app->smarty->assign('display_otherincomes',     $this->app->components->otherincome->getRecords('otherincome_id', 'DESC', 25, true, \CMSApplication::$VAR['page_no'], \CMSApplication::$VAR['search_category'], \CMSApplication::$VAR['search_term'], \CMSApplication::$VAR['filter_type'], \CMSApplication::$VAR['filter_status']));
