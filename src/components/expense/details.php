...
$this->app->smarty->assign('display_creditnotes',     $this->app->components->creditnote->getRecords('creditnote_id', 'DESC', 0, false, null, null, null, null, null, null, null, null, null, null, \CMSApplication::$VAR['expense_id']));

// Misc
$this->app->smarty->assign('employee_display_name',    $this->app->components->user->getRecord($expense_details['employee_id'], 'display_name'));
$this->app->smarty->assign('allowed_to_edit',          $this->app->components->expense->checkRecordAllowsEdit(\CMSApplication::$VAR['expense_id'], true));
