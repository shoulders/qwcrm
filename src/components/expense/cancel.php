...
// Cancel the expense
$this->app->components->expense->cancel_expense(\CMSApplication::$VAR['expense_id']);

// Load the expense search page
$this->app->system->general->force_page('expense', 'search', 'msg_success='._gettext("Expense cancelled successfully."));