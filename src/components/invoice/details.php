...
$this->app->smarty->assign('display_creditnotes',     $this->app->components->creditnote->getRecords('creditnote_id', 'DESC', 0, false, null, null, null, null, null, null, null, null, null, \CMSApplication::$VAR['invoice_id']));
...
$this->app->smarty->assign('allowed_to_edit',          $this->app->components->invoice->checkRecordAllowsEdit(\CMSApplication::$VAR['invoice_id']));
