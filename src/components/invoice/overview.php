...
$smarty->assign('overview_invoices_paid',               display_invoices('invoice_id', 'DESC', false, '15', null, null, null, 'paid')              );
...
$smarty->assign('overview_invoices_refunded',           display_invoices('invoice_id', 'DESC', false, '15', null, null, null, 'refunded')          );
$smarty->assign('overview_invoices_cancelled',          display_invoices('invoice_id', 'DESC', false, '15', null, null, null, 'cancelled')         );
