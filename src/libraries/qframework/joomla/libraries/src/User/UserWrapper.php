...
class UserWrapper
{
	 ...
	 * @deprecated  4.0  Use `Joomla\CMS\User\UserHelper` directly
	 */
	public function addUserToGroup($user_id, $groupId)
	{
		return UserHelper::addUserToGroup($user_id, $groupId);
	}
	...
	{
		return UserHelper::getUserGroups($user_id);
	}
	 ...
	 * @deprecated  4.0  Use `Joomla\CMS\User\UserHelper` directly
	 */
	public function removeUserFromGroup($user_id, $groupId)
	{
		return UserHelper::removeUserFromGroup($user_id, $groupId);
	}
	 ...
	 * @deprecated  4.0  Use `Joomla\CMS\User\UserHelper` directly
	 */
	public function setUserGroups($user_id, $groups)
	{
		return UserHelper::setUserGroups($user_id, $groups);
	}
	...
	{
		return UserHelper::getProfile($user_id);
	}
	 ...
	 * @deprecated  4.0
	 */
	public function invalidateCookie($user_id, $cookieName)
	{
		return UserHelper::invalidateCookie($user_id, $cookieName);
	}
