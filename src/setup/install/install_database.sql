...
CREATE TABLE `#__company_record` (
  ...
  `creditnote_expiry_offset` int(5) UNSIGNED NOT NULL DEFAULT 365,
  `voucher_expiry_offset` int(5) UNSIGNED NOT NULL DEFAULT 1826,
...
INSERT INTO `#__company_vat_tax_codes` (`id`, `tax_key`, `display_name`, `description`, `rate`, `hidden`, `editable`, `enabled`) VALUES
(1, 'T0', 'Zero Rate', 'Zero rated transactions', '0.00', 0, 0, 1),
(2, 'T1', 'Standard Rate', 'Standard rated transactions', '20.00', 0, 1, 1),
(3, 'T2', 'Exempt', 'Exempt transactions', '0.00', 0, 0, 1),
(4, 'T3', '', '', '0.00', 0, 0, 0),
(5, 'T4', 'Sales - Goods - EC VAT Customers', 'Sale of goods to VAT registered customers in EC', '0.00', 0, 0, 1),
(6, 'T5', 'Reduced Rate', 'Lower rated transactions', '5.00', 0, 1, 1),
(7, 'T6', '', '', '0.00', 0, 0, 0),
(8, 'T7', 'Zero Rate Purchases - Goods - EC', 'Zero rated purchases of goods from suppliers in EC', '0.00', 0, 0, 1),
(9, 'T8', 'Standard Rate Purchases - Goods - EC', 'Standard rated purchases of goods from suppliers in EC', '0.00', 0, 0, 1),
(10, 'T9', 'Transactions not involving VAT', 'Transactions not involving VAT. This is the default non-vatable tax code.', '0.00', 0, 0, 1),
(11, 'T10', '', '', '0.00', 0, 0, 0),
(12, 'T11', '', '', '0.00', 0, 0, 0),
(13, 'T12', '', '', '0.00', 0, 0, 0),
(14, 'T13', '', '', '0.00', 0, 0, 0),
...
(19, 'T18', '', '', '0.00', 0, 0, 0),
(20, 'T19', '', '', '0.00', 0, 0, 0),
(21, 'T20', 'Reverse Charges', 'Sale or purchase of items that fall under the remit of carousel fraud', '0.00', 0, 0, 1),
(22, 'T21', '', '', '0.00', 0, 0, 0),
(23, 'T22', 'Sales - Services - EC VAT Customers', 'Sales of services to VAT registered customers in EC', '0.00', 0, 0, 1),
(24, 'T23', 'Zero Rate / Exempt Purchases - Services - EC', 'Zero rated or exempt purchases of services from suppliers in EC', '0.00', 0, 0, 1),
(25, 'T24', 'Standard Rate Purchases - Services - EC', 'Standard rated purchases of services from suppliers in EC', '0.00', 0, 0, 1),
(26, 'T25', 'Flat Rate Capital Asset', 'UK Flat Rate scheme only - Purchase or sale of capital items, where the purchase amount is more than &pound;2,000 inclusive of VAT.', '0.00', 0, 0, 1);
...
-- Indexes for table `#__creditnote_types`
--
ALTER TABLE `#__creditnote_action_types`
  ADD PRIMARY KEY (`id`);
