<!-- dashboard_workorders_on_hold_block.tpl -->
{*
 * @package   QWcrm
...
<table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
        ...
        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=workorder:details&workorder_id={$on_hold_workorders[o].workorder_id}&customer_id={$on_hold_workorders[o].customer_id}';" class="row1">
            ...
            <td class="olotd4" align="center">
                {section name=s loop=$workorder_statuses}    
                    {if $on_hold_workorders[o].workorder_status == $workorder_statuses[s].status_key}{t}{$workorder_statuses[s].display_name}{/t}{/if}        
                {/section}                  
            </td>
    ...
    {sectionelse}
        <tr>
            <td colspan="7" class="error">{t}There are no work orders on hold{/t}</td>
        </tr>
    {/section}
</table>