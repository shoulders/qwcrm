            ...
            <table width="700" cellpadding="5" cellspacing="0" border="0" >
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">                                               
                        <a href="index.php?component=workorder&page_tpl=print&workorder_id={$workorder_id}&print_content=technician_workorder_slip&print_type=htmlBrowser&themeVar=print" target="_blank">                                                    
                        ...
                        <a href="index.php?component=workorder&page_tpl=print&workorder_id={$workorder_id}&print_content=technician_job_sheet&print_type=htmlBrowser&themeVar=print" target="_blank">                                                    
                        ...
                        <a href="index.php?component=workorder&page_tpl=print&workorder_id={$workorder_id}&print_content=client_workorder_slip&print_type=htmlBrowser&themeVar=print" target="_blank">                                                    
