...
<table class="olotable" width="100%" border="0" cellpadding="4" cellspacing="0">
    ...
    {section name=w loop=$display_workorders}        
        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?page=workorder:details&workorder_id={$display_workorders[w].workorder_id}';" class="row1">

            <!-- WO ID -->
            <td class="olotd4"><a href="index.php?page=workorder:details&workorder_id={$display_workorders[w].workorder_id}">{$display_workorders[w].workorder_id}</a></td>

            <!-- INV ID -->
            <td class="olotd4"><a href="index.php?page=invoice:details&invoice_id={$display_workorders[w].invoice_id}">{$display_workorders[w].invoice_id}</a></td>
            ...
            <td class="olotd4" nowrap>
                ...
                <a class="link1" href="index.php?page=customer:details&customer_id={$display_workorders[w].customer_id}">{$display_workorders[w].customer_display_name}</a>
            </td>
            ...
            <td class="olotd4" nowrap>
                ...
                <a class="link1" href="index.php?page=user:details&user_id={$display_workorders[w].employee_id}">{$display_workorders[w].employee_display_name}</a>
            </td>            

            <!-- Action -->
            <td class="olotd4" align="center" nowrap>
                <a href="index.php?page=workorder:print&workorder_id={$display_workorders[w].workorder_id}&print_content=technician_workorder_slip&print_type=print_html&theme=print" target="_blank">                                                    
                ...
                <a href="index.php?page=workorder:print&workorder_id={$display_workorders[w].workorder_id}&print_content=technician_job_sheet&print_type=print_html&theme=print" target="_blank">                                                    
                ...
                <a href="index.php?page=workorder:print&workorder_id={$display_workorders[w].workorder_id}&print_content=customer_workorder_slip&print_type=print_html&theme=print" target="_blank">                                                    
                ...
                <a href="index.php?page=workorder:details&workorder_id={$display_workorders[w].workorder_id}&customer_id={$display_workorders[w].customer_id}">
