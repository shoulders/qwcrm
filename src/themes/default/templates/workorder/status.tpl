                            ...
                            <tr>
                                ...
                                <td class="olotd4" align="center" width="33%">                                    
                                    {if $allowed_to_change_status}
                                        <p>&nbsp;</p>
                                        <form action="index.php?component=workorder&page_tpl=status" method="post" name="new_workorder_status" id="new_workorder_status">
                                            <b>{t}New Status{/t}: </b>
                                ...
                                <td class="olotd4" align="center" width="33%">
                                    {if $allowed_to_change_employee}
                                        ...
                                        {if ($assigned_employee_id == $login_user_id && $workorder_status != 6) || $assigned_employee_id == '' || $login_usergroup_id <= 3}
                                            <p>&nbsp;</p>  
                                            <form method="post" action="index.php?component=workorder&page_tpl=status">
