    ...
    <table width="750" border="0" cellpadding="2" cellspacing="0" style="border-collapse: collapse;">
        <tr bgcolor="#999999">
            ...
            <td valign="top" align="center">
                <font size="+3">{t}Client Work Order Slip{/t}</font><br />
                    ...
                    <tr>
                        <td>
                            ...
                            <p>
                                ...
                                <b>{t}Website{/t}: </b>{$company_details.website|regex_replace:"/^https?:\/\//":""|regex_replace:"/\/$/":""}<br>
    ...
    <table width="750" border="1" cellpadding="2" cellspacing="0" style="border-collapse: collapse;">
        ...
        <tr>
            ...
            <td valign="top" width="20%">
                ...
                <table border="0" cellpadding="4" cellspacing="0">
                    <tr>
                        <td valign="top" width="50%"><b>{t}Work Order ID{/t}</b></td>
                    ...
                    <tr>
                        <td valign="top"><b>{t}Work Order Status{/t}</b></td>
                        <td valign="top">
