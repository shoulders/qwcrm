                                                                ...
                                                                <table>
                                                                    <tbody align="left">
                                                                        <tr>
                                                                            ...
                                                                            <td colspan="3"><input name="display_name" class="olotd5" size="50" value="{$customer_details.display_name}" type="text" maxlength="50" required onkeydown="return onlyName(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right"><strong>{t}Contact Name{/t}</strong></td>
                                                                            <td><input name="last_name" class="olotd5" value="{$customer_details.contact_name}" size="50" type="text" maxlength="50" onkeydown="return onlyName(event);"/></td>
                                                                        </tr>
                                                                        <tr>
