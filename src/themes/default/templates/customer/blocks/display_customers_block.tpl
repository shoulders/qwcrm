...
<table class="olotable" width="100%" border="0" cellpadding="5" cellspacing="0">
    ...
    {section name=c loop=$display_customers}
        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?component=customer&page_tpl=details&customer_id={$display_customers[c].customer_id}';" class="row1">
            ...
            <td class="olotd4" nowrap>
                <a href="index.php?component=customer&page_tpl=details&customer_id={$display_customers[c].customer_id}"><img src="{$theme_images_dir}icons/16x16/viewmag.gif" alt="" border="0" onMouseOver="ddrivetip('{t}View Customer Details{/t}');" onMouseOut="hideddrivetip()"></a>&nbsp;
                <a href="index.php?component=workorder&page_tpl=new&customer_id={$display_customers[c].customer_id}"><img src="{$theme_images_dir}icons/16x16/small_new_work_order.gif" alt="" border="0" onMouseOver="ddrivetip('{t}New Work Order{/t}');" onMouseOut="hideddrivetip();" alt=""></a>&nbsp;
                <a href="index.php?component=invoice&page_tpl=edit&invoice_type=invoice-only&workorder_id=0&customer_id={$display_customers[c].customer_id}"><img src="{$theme_images_dir}icons/16x16/small_new_invoice_only.gif" alt="" border="0" onMouseOver="ddrivetip('{t}New Invoice Only{/t}');" onMouseOut="hideddrivetip();" alt=""></a>
                <a href="index.php?component=user&page_tpl=new&customer_id={$display_customers[c].customer_id}"><img src="{$theme_images_dir}icons/16x16/small_new_customer.gif" alt="" border="0" onMouseOver="ddrivetip('{t}New Customer Login{/t}');" onMouseOut="hideddrivetip();" alt=""></a>
            </td>
        </tr>
    {sectionelse}
        <tr>
            <td colspan="8" class="error">{t}There are no customers.{/t}</td>
        </tr>        
    {/section}
</table>