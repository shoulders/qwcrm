                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" border="0" id="payments_log">
                                        ...
                                        <tr>
                                            <td class="menutd2">
                                                ...
                                                {if $creditnote_details.invoice_id && ((float) $parent_record_balance && $creditnote_details.status == 'unused')}
                                                ...
                                                {if $creditnote_details.expense_id && ((float) $parent_record_balance && $creditnote_details.status == 'unused')}
                                                ...
                                                {if $creditnote_details.client_id && (!(float) $parent_record_balance && ($creditnote_details.status == 'unused' || $creditnote_details.status == 'partially_used'))}
