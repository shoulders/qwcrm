        ...
        <tr class="row1" onmouseover="this.className='row2';" onmouseout="this.className='row1';" {if $display_vouchers[g].status != 'deleted'}onDblClick="window.location='index.php?component=voucher&page_tpl=details&voucher_id={$display_vouchers[g].voucher_id}';"{/if}>
            ...
            <td class="olotd4">
                {if $display_vouchers[g].status != 'deleted'}
                    ...
                    <a href="index.php?component=voucher&page_tpl=print&voucher_id={$display_vouchers[g].voucher_id}&commContent=voucher&commType=htmlBrowser" target="_blank"><img src="{$theme_images_dir}icons/16x16/fileprint.gif" border="0" onMouseOver="ddrivetip('{t}Print the Voucher{/t}');" onMouseOut="hideddrivetip();"></a>
