<!-- new_payment_method_cheque_block.tpl -->
{*
 * @package   QWcrm
            ...
            <td class="menutd2">
                <table width="100%" cellpadding="4" cellspacing="0" border="0" width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
                    ...
                    <tr class="olotd4">
                        <td></td>
                        <td>
                            <input id="cheque_date" name="qpayment[date]" class="olotd4" size="10" value="{$smarty.now|date_format:$date_format}" type="text" maxlength="10" pattern="{literal}^[0-9]{2,4}(?:\/|-)[0-9]{2}(?:\/|-)[0-9]{2,4}${/literal}" required onkeydown="return onlyDate(event);">
                        ...
                        <td><input name="qpayment[cheque_number]" class="olotd5" type="text" maxlength="15" required onkeydown="return onlyNumber(event);"></td>                        
                ...
                <p>     
                    ...
                    <input type="hidden" name="qpayment[method]" value="cheque">                    
                </p>
            </td>
        </tr>
    </table>
