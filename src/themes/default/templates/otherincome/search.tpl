                                                                ...
                                                                <td>
                                                                    ...
                                                                    <select class="olotd5" id="filter_type" name="filter_type">
                                                                        ...
                                                                        {section name=t loop=$otherincome_types}    
                                                                            <option value="{$otherincome_types[t].otherincome_type_id}"{if $filter_type == $otherincome_types[t].otherincome_type_id} selected{/if}>{t}{$otherincome_types[t].display_name}{/t}</option>        
                                                                        {/section}
                                                                    </select>
                                                                </td>
                                                            </tr> 
