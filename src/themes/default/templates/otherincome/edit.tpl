                                                ...
                                                <table width="100%" cellpadding="2" cellspacing="2" border="0">  
                                                    ...
                                                    <form action="index.php?component=otherincome&page_tpl=edit&otherincome_id={$otherincome_id}" method="post" name="edit_otherincome" id="edit_otherincome" autocomplete="off">                                                        
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3"><input id="invoice_id" name="invoice_id" class="olotd5" size="5" value="{$otherincome_details.invoice_id}" type="text" maxlength="10" onkeydown="return onlyNumber(event);"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <select id="payment_method" name="payment_method" class="olotd5">
                                                                {section name=s loop=$payment_methods}    
                                                                    <option value="{$payment_methods[s].purchase_method_id}"{if $otherincome_details.payment_method == $payment_methods[s].purchase_method_id} selected{/if}>{t}{$payment_methods[s].display_name}{/t}</option>
                                                                {/section} 
                                                            </select>
                                                        </td>
                                                        </tr>
