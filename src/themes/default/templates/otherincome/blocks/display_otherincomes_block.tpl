        ...
        <tr onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?component=otherincome&page_tpl=details&otherincome_id={$display_otherincomes[r].otherincome_id}';" class="row1">                                                                
            ...
            <td class="olotd4" nowrap>
                {section name=s loop=$otherincome_types}    
                    {if $display_otherincomes[r].type == $otherincome_types[s].otherincome_type_id}{t}{$otherincome_types[s].display_name}{/t}{/if}        
                {/section}   
            </td>                                                                
            <td class="olotd4" nowrap>
                {section name=s loop=$payment_methods}    
                    {if $display_otherincomes[r].payment_method == $payment_methods[s].purchase_method_id}{t}{$payment_methods[s].display_name}{/t}{/if}        
                {/section} 
            </td>                                                               
