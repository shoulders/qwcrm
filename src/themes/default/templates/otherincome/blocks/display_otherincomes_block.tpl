...
<table class="olotable" width="100%" border="0" cellpadding="5" cellspacing="0">
    ...
    {section name=r loop=$display_otherincomes.records}                                                            
        <!-- This allows double clicking on a row and opens the corresponding otherincome view details -->
        <tr class="row1" onmouseover="this.className='row2';" onmouseout="this.className='row1';"{if $display_otherincomes.records[r].status != 'deleted'} onDblClick="window.location='index.php?component=otherincome&page_tpl=details&otherincome_id={$display_otherincomes.records[r].otherincome_id}';"{/if}>                                                                
            <td class="olotd4" nowrap><a href="index.php?component=otherincome&page_tpl=details&otherincome_id={$display_otherincomes.records[r].otherincome_id}">{$display_otherincomes.records[r].otherincome_id}</a></td>
            <td class="olotd4" nowrap>{$display_otherincomes.records[r].payee}</td>                                                                
            <td class="olotd4" nowrap>{$display_otherincomes.records[r].date|date_format:$date_format}</td>                                                                
            <td class="olotd4" nowrap>
                {section name=s loop=$otherincome_types}    
                    {if $display_otherincomes.records[r].type == $otherincome_types[s].type_key}{t}{$otherincome_types[s].display_name}{/t}{/if}        
                {/section}   
            </td>                                                                
             {if '/^vat_/'|preg_match:$qw_tax_system} 
            ...
            <td class="olotd4" nowrap>{$currency_sym}{$display_otherincomes.records[r].balance|string_format:"%.2f"}</td> 
            <td class="olotd4" nowrap>
            ...
            <td class="olotd4" nowrap>
                ...
                <a href="index.php?component=otherincome&page_tpl=edit&otherincome_id={$display_otherincomes.records[r].otherincome_id}">
                ...
                {*<a href="index.php?component=otherincome&page_tpl=delete&otherincome_id={$display_otherincomes.records[r].otherincome_id}" onclick="return confirm('{t}Are you Sure you want to delete this Other IncomeRecord? This will permanently remove the record from the database.{/t}');">
    ...
    {if $display_otherincomes.restricted_records}
        <tr>
            <td colspan="13">{t}Not all records are shown.{/t} {t}Click{/t} <a href="index.php?component=otherincome&page_tpl=search">{t}here{/t}</a> {t}to see all records.{/t}</td>
        </tr>
    {/if}
