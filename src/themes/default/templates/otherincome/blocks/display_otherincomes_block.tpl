...
<table class="olotable" width="100%" border="0" cellpadding="5" cellspacing="0">
    ...
    {section name=e loop=$display_otherincomes.records}
        ...
        <tr class="row1" onmouseover="this.className='row2';" onmouseout="this.className='row1';"{if $display_otherincomes.records[e].status != 'deleted'} onDblClick="window.location='index.php?component=otherincome&page_tpl=details&otherincome_id={$display_otherincomes.records[e].otherincome_id}';"{/if}>
            ...
            <td class="olotd4" nowrap><a href="index.php?component=supplier&page_tpl=details&supplier_id={$display_otherincomes.records[e].supplier_id}">{$display_otherincomes.records[e].supplier_id}</a></td>
            <td class="olotd4" nowrap>{$display_otherincomes.records[e].display_name}</td>
            ...
            {if '/^vat_/'|preg_match:$qw_tax_system}
                <td class="olotd4" nowrap>{$currency_symbol}{$display_otherincomes.records[e].unit_net|string_format:"%.2f"}</td>
                <td class="olotd4" nowrap>{$currency_symbol}{$display_otherincomes.records[e].unit_tax|string_format:"%.2f"}</td>
            {/if}
            <td class="olotd4" nowrap>{$currency_symbol}{$display_otherincomes.records[e].unit_gross|string_format:"%.2f"}</td>
            <td class="olotd4" nowrap>{$currency_symbol}{$display_otherincomes.records[e].balance|string_format:"%.2f"}</td>
            <td class="olotd4" nowrap>
