...
<table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
    <tr class="olotd4">
        ...
        {if '/^vat_/'|preg_match:$expense_details.tax_system}<td class="olohead"><b>{t}VAT{/t}</b></td>{/if}        
    ...
    <tr class="olotd4">
        ...
        {if '/^vat_/'|preg_match:$expense_details.tax_system}<td class="olotd4">{$currency_sym}{$expense_details.unit_tax|string_format:"%.2f"}</td>{/if}
