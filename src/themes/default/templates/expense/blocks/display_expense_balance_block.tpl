...
<table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
    ...
    <tr class="olotd4">
        ...
        {if '/^vat_/'|preg_match:$expense_details.tax_system}
            <td class="olotd4">{$currency_symbol}{$expense_details.unit_net|string_format:"%.2f"}</td>
            <td class="olotd4">{$currency_symbol}{$expense_details.unit_tax|string_format:"%.2f"}</td>
        {/if}
        <td class="olotd4">{$currency_symbol}{$expense_details.unit_gross|string_format:"%.2f"}</td>
        <td class="olotd4">{$currency_symbol}{($expense_details.unit_gross - $expense_details.balance)|string_format:"%.2f"}</td>
        <td class="olotd4"><font color="#cc0000"><b>{$currency_symbol}{$expense_details.balance|string_format:"%.2f"}</b></font></td>
        <td class="olotd4">
