            ...
            <table width="700" cellpadding="5" cellspacing="0" border="0" >
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">
                        <a>
                            <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=js}EXPENSE_NEW_HELP_TITLE{/t}</strong></div><hr><div>{t escape=js}EXPENSE_NEW_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">
                        </a>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td class="menutd">
                                    <table class="menutable" width="100%" border="0" cellpadding="2" cellspacing="2">
                                        <tr>
                                            <td>                                                                                             
                                                <form method="post" action="index.php?component=expense&page_tpl=new" name="new_expense" id="new_expense" class="amend_values">
