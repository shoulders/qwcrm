                                    ...
                                    <td class="menutd">
                                        ...
                                        <table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
                                            ...
                                            <tr class="olotd4">
                                                ...
                                                <td>{$currency_symbol}<span id="expenseTotalGrossTop">0.00</span></td>
                                                            ...
                                                            <td class="menutd2">
                                                                <table width="100%" border="1" cellpadding="3" cellspacing="0" class="olotable">
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td class="olotd4" width="20%" align="right">
                                                                            {$currency_symbol}<span id="expenseTotalGrossText">0.00</span>
                                        ...
                                        <table width="100%"  cellpadding="3" cellspacing="0" border="0">
                                            <tr>
                                                <td align="left" valign="top" width="100%">
                                                    ...
                                                    <button type="submit" name="submit" value="submitandapprove" onclick="return confirm('{t}Are you sure you want to submit and approve this expense?{/t}');">{t}Submit and Approve{/t}</button>
