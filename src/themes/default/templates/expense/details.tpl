            ...
            <table width="100%" cellpadding="4" cellspacing="0" border="0">
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">
                        ...
                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=js}EXPENSE_DETAILS_HELP_TITLE{/t}</strong></div><hr><div>{t escape=js}EXPENSE_DETAILS_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">                        
                    </td>
                </tr>
                <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td class="menutd">              
                                                {section name=s loop=$expense_types}    
                                                    {if $expense_details.item == $expense_types[s].type_key}{t}{$expense_types[s].display_name}{/t}{/if}        
                                                {/section}   
                                            </td>
                                            {if '/^vat_/'|preg_match:$expense_details.tax_system}
