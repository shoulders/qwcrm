                                                                            ...
                                                                            <table>
                                                                                <tbody align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input id="confirmPassword" name="qform[confirmPassword]" class="olotd5" type="password" minlength="8" maxlength="20" required oninput="checkPasswordsMatch('{t}Passwords Match!{/t}', '{t}Passwords Do Not Match!{/t}', true);" onkeydown="onlyPassword(event);">
