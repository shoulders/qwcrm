            ...
            <table width="900" cellpadding="5" cellspacing="0" border="0">
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">                        
                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=js}USER_NEW_HELP_TITLE{/t}</strong></div><hr><div>{t escape=js}USER_NEW_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="100%" class="olotable" cellpadding="5" cellspacing="0" border="0">
                            <tr>
                                <td width="100%" valign="top">                                    
                                    <form action="index.php?component=user&page_tpl=new" method="post" name="new_user" id="new_user" onsubmit="return confirmPasswordsMatch();"> 
                                                                                ...
                                                                                <tbody align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            {if !$is_employee}
                                                                                                ...
                                                                                                <input type="hidden" name="qform[is_employee]" value="0">
                                                                                            {else}
                                                                                                <span style="color: red; font-weight: 900;">{t}Employee{/t}</span>
                                                                                                <input type="hidden" name="qform[is_employee]" value="1">
                                                                                            {/if}
                                                                                    ...
                                                                                    {if $is_employee}
                                                                                        <tr>
                                                                                            ...
                                                                                            <td>
                                                                                                <select name="qform[based]" class="olotd5" required>
                                                                                                ...
                                                                                                <input type="hidden" name="qform[client_id]" value="">
                                                                                            </td>
                                                                                        </tr>
                                                                                    {else}
                                                                                        <tr>
                                                                            ...
                                                                            <table>
                                                                                <tbody align="left">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td><input id="password" name="qform[password]" class="olotd5" type="password" minlength="8" maxlength="20" required oninput="checkPasswordsMatch('{t}Passwords Match!{/t}', '{t}Passwords Do Not Match!{/t}', true);" onkeydown="return onlyPassword(event);"></td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <td align="right"><strong>{t}Confirm Password{/t}</strong></td>
                                                                                        <td>
                                                                                            <input id="confirmPassword" name="qform[confirmPassword]" class="olotd5" type="password" minlength="8" maxlength="20" required oninput="checkPasswordsMatch('{t}Passwords Match!{/t}', '{t}Passwords Do Not Match!{/t}', true);" onkeydown="return onlyPassword(event);">
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>                                                                                                
                                                                                            <select name="qform[usergroup]" class="olotd5" required>
                                                                                                <option selected hidden disabled></option>
