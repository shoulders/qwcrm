                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {if $previous_page_no && $display_users}
                                                                    ...
                                                                    <a href="index.php?component=user&page_tpl=search&search_category={$search_category}&search_term={$search_term}&page_no={$previous_page_no}{if $filter_status}&filter_status={$filter_status}{/if}{if $filter_usertype}&filter_status={$filter_usertype}{/if}{if $filter_usergroup}&filter_usergroup={$filter_usergroup}{/if}"><img src="{$theme_images_dir}back_24.gif" border="0" alt=""></a>&nbsp;
                                                                {/if}
                                                            </td>                                                   
                                                            ...
                                                            <td>
                                                                {if $next_page_no && $display_users}
                                                                    <a href="index.php?component=user&page_tpl=search&search_category={$search_category}&search_term={$search_term}&page_no={$next_page_no}{if $filter_status}&filter_status={$filter_status}{/if}{if $filter_usertype}&filter_status={$filter_usertype}{/if}{if $filter_usergroup}&filter_usergroup={$filter_usergroup}{/if}"><img src="{$theme_images_dir}forwd_24.gif" border="0" alt=""></a>                                                   
                                                                    <a href="index.php?component=user&page_tpl=search&search_category={$search_category}&search_term={$search_term}&page_no={$total_pages}{if $filter_status}&filter_status={$filter_status}{/if}{if $filter_usertype}&filter_status={$filter_usertype}{/if}{if $filter_usergroup}&filter_usergroup={$filter_usergroup}{/if}"><img src="{$theme_images_dir}fastf_24.gif" border="0" alt=""></a>
                                                                {/if}
                                                            </td>                                                                                             
