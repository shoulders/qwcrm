                                ...
                                <td width="100%" valign="top">
                                    ...
                                    <div id="tabs_container">
                                        ...
                                        <ul class="tabs">
                                            ...
                                            <li><a href="javascript:void(0)" rel="#tab_2_contents" class="tab"><img src="{$theme_images_dir}icons/users.gif" alt="" border="0" height="14" width="14" />&nbsp;{t}Open Work Orders{/t}</a></li>
                                        </ul>
