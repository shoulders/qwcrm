                                    ...
                                    <form action="index.php?component=user&page_tpl=reset" method="post" onsubmit="return confirmPasswordsMatch();">
                                        <table width="75%" cellspacing="0" border="0" cellpadding="5" align="center">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input id="confirmPassword" name="confirmPassword" class="olotd5" type="password" minlength="8" maxlength="20" requireed onkeyup="checkPasswordsMatch('{t}Passwords Match!{/t}', '{t}Passwords Do Not Match!{/t}', true);" onkeydown="onlyPassword(event);">
