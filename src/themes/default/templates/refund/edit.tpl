            ...
            <table width="700" cellpadding="5" cellspacing="0" border="0" >
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">
                        <a>
                            <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=js}REFUND_EDIT_HELP_TITLE{/t}</strong></div><hr><div>{t escape=js}REFUND_EDIT_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">
                        </a>
                    </td>
                </tr>
                <tr>
                                                ...
                                                <table width="100%" cellpadding="2" cellspacing="2" border="0">  
                                                    ...
                                                    <form action="index.php?component=refund&page_tpl=edit&refund_id={$refund_id}" method="post" name="edit_refund" id="edit_refund" autocomplete="off">                                                        
                                                        ...
                                                        <tr{if $refund_details.tax_system == 'no_tax'} hidden{/if}>
                                                            ...
                                                            <td>{$currency_sym}{$refund_details.unit_tax_rate|string_format:"%.2f"}</td>
                                                        </tr>
                                                        <tr{if $refund_details.tax_system == 'no_tax'} hidden{/if}>
