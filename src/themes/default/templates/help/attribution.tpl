...
<div style="padding: 20px;">
    ...
    <ul>
        ...
        <li><strong>Name | Version | License | URL | What it does?</strong></li>
        ...
        <li>psr/cache | v1.0.1 | MIT | https://github.com/php-fig/cache | Common interface for caching libraries</li>
        <li>psr/log | v1.0.2 | MIT | https://github.com/php-fig/log | Common interface for logging libraries</li>        
        <li>psr/simple-cache | v1.0.0 | MIT | https://github.com/php-fig/simple-cache | Common interfaces for simple caching</li>
        <li>setasign/fpdi | v1.6.2 | MIT | https://github.com/Setasign/FPDI | FPDI is a collection of PHP classes facilitating developers to read pages from existing PDF documents and use them as templates in FPDF.</li>        
        <li>Smarty | v3.1.30 | LGPL 2.1 or later | https://www.smarty.net/ | Smarty - the compiling PHP template engine</li>
        <li>swiftmailer | v5.4.8 | MIT | Swiftmailer, free feature-rich PHP mailer | https://github.com/swiftmailer/swiftmailer</li>
