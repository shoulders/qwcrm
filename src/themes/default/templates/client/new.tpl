                                                                ...
                                                                <table>
                                                                    <tbody align="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input name="website" class="olotd5" size="50" type="text" maxlength="50" placeholder="https://quantumwarp.com/" pattern="{literal}^(https?:\/\/)?([a-z0-9_\-]+\.?)+(\/([a-zA-Z0-9_\-~#]+)*\/?)?{/literal}" onkeydown="return onlyURL(event);"></td>
                                                                        </tr>
                                                                        <tr>
