...
<head>
    ...
    <!-- PDF Title -->
    <title>{t}CLIENT_PRINT_ENVELOPE_PAGE_TITLE{/t}</title>

    <!-- PDF Subject -->
    <meta name="description" content="{t}CLIENT_PRINT_ENVELOPE_META_DESCRIPTION{/t}">

    <!-- PDF Keywords -->
    <meta name="keywords" content="{t}CLIENT_PRINT_ENVELOPE_META_KEYWORDS{/t}">
