                                                                ...
                                                                <table>
                                                                    <tbody align="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input name="qform[discount_rate]" class="olotd5" size="4" value="{$client_details.discount_rate|string_format:"%.2f"}" min="0" max="100" step="0.01" type="text" maxlength="5" pattern="{literal}^[0-9]{0,2}(\.[0-9]{0,2})?${/literal}" required onkeydown="return onlyNumberPeriod(event);"/><b>%</b></td>
                                                                        </tr>
                                                                    </table>
                                                                </td>
                                                            </tr>
