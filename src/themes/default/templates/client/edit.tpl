                                                                ...
                                                                <table>
                                                                    <tbody align="left">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input name="website" class="olotd5" value="{$client_details.website}" size="50" type="text" maxlength="50" placeholder="https://quantumwarp.com/" pattern="{literal}^(https?:\/\/)?([a-z0-9]+\.)*([a-z0-9]+\.[a-z]+)(\/[a-zA-Z0-9#]+\/?)*${/literal}" onkeydown="return onlyURL(event);"/></td>
                                                                        </tr>
                                                                        <tr>
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td><input name="unit_discount_rate" class="olotd5" size="4" value="{$client_details.unit_discount_rate|string_format:"%.2f"}" type="text" maxlength="5" pattern="{literal}^[0-9]{0,2}(\.[0-9]{0,2})?${/literal}" required onkeydown="return onlyNumberPeriod(event);"/><b>%</b></td>
                                                                        </tr>                                                                                  
                                                                    </table>
                                                                </td>
                                                            </tr>
