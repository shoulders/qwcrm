                            ...
                            <tr>
                                <td width="100%" valign="top">                                    
                                    <form method="post" action="index.php?component=client&page_tpl=note_edit&client_note_id={$client_note.client_note_id}">
                                        ...
                                        {*<div>
                                            <b>{t}Date{/t}:<b><br>
                                            <input id="date" name="date" class="olotd4" size="10" value="{$client_note.date|date_format:$date_format}" type="text" maxlength="10" pattern="{literal}^[0-9]{2,4}(?:\/|-)[0-9]{2}(?:\/|-)[0-9]{2,4}${/literal}" required onkeydown="return onlyDate(event);">
