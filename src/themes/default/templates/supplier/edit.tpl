                                                ...
                                                <form action="index.php?component=supplier&page_tpl=edit&supplier_id={$supplier_id}" method="post" name="edit_supplier" id="edit_supplier" autocomplete="off">                                                
                                                    <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="website" class="olotd5" size="50" value="{$supplier_details.website}" type="text"  maxlength="50" pattern="{literal}^(https?:\/\/)?([a-z0-9_\-]+\.?)+(\/([a-zA-Z0-9_\-~#]+)*\/?)?{/literal}" placeholder="https://quantumwarp.com/" onkeydown="return onlyURL(event);"></td>
                                                        </tr>
                                                        <tr>
