            ...
            <table width="700" cellpadding="5" cellspacing="0" border="0" >
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">
                        <a>
                            <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=js}SUPPLIER_EDIT_HELP_TITLE{/t}</strong></div><hr><div>{t escape=js}SUPPLIER_EDIT_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">
                        </a>
                    </td>
                </tr>
                <tr>
                                                ...
                                                <form action="index.php?component=supplier&page_tpl=edit&supplier_id={$supplier_id}" method="post" name="edit_supplier" id="edit_supplier" autocomplete="off">
                                                    <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="qform[company_name]" class="olotd5" size="50" value="{$supplier_details.company_name}" type="text" maxlength="50" onkeydown="return onlyName(event);"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="qform[website]" class="olotd5" size="50" value="{$supplier_details.website}" type="text"  maxlength="50" pattern="{literal}^(https?:\/\/)?([a-z0-9_\-]+\.?)+(\/([a-zA-Z0-9_\-~#]+)*\/?)?{/literal}" placeholder="https://quantumwarp.com/" onkeydown="return onlyURL(event);"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><b>{t}Email{/t}</b></td>
                                                            <td><input name="qform[email]" class="olotd5" size="50" value="{$supplier_details.email}" type="email" placeholder="no-reply@quantumwarp.com" maxlength="50" onkeydown="return onlyEmail(event);"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input class="olotd5" name="qform[primary_phone]" size="20" value="{$supplier_details.primary_phone}" type="tel" maxlength="20" onkeydown="return onlyPhoneNumber(event);"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><b>{t}Mobile{/t}</b></td>
                                                            <td><input class="olotd5" name="qform[mobile_phone]" type="tel" size="20" value="{$supplier_details.mobile_phone}" maxlength="20" onkeydown="return onlyPhoneNumber(event);"></td>
                                                        </tr>
                                                        <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input name="qform[city]" class="olotd5" value="{$supplier_details.city}" type="text" maxlength="20" onkeydown="return onlyAlpha(event);"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><strong>{t}State{/t}</strong></td>
                                                            <td><input name="qform[state]" class="olotd5" value="{$supplier_details.state}" type="text" maxlength="20" onkeydown="return onlyAlpha(event);"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><strong>{t}Zip{/t}</strong></td>
                                                            <td><input name="qform[zip]" class="olotd5" value="{$supplier_details.zip}" type="text" maxlength="20" onkeydown="return onlyAlphaNumeric(event);"></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><strong>{t}Country{/t}</strong></td>
                                                            <td><input name="qform[country]" class="olotd5" value="{$supplier_details.country}" type="text" maxlength="50" onkeydown="return onlyAlpha(event);"></td>
                                                        </tr>
                                                        <tr>
                                                            <td class="menuhead" colspan="2"><b>{t}Information{/t}</b></td>
                                                        </tr>
                                                        <tr>
                                                            <td align="right"><strong>{t}Additional Info{/t}</strong></td>
                                                            <td>{if $supplier_details.additional_info|supplier_addinfo_display}{$supplier_details.additional_info|supplier_addinfo_display}{else}{t}none{/t}{/if}</td>
                                                        </tr>
                                                        <tr>
