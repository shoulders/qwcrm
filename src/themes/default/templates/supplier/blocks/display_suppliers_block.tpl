    ...
    {section name=s loop=$display_suppliers}
        ...
        <tr class="row1" onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?component=supplier&page_tpl=details&supplier_id={$display_suppliers[s].supplier_id}';">                                                           
            ...
            <td class="olotd4" nowrap>
                ...
                {*<a href="index.php?component=supplier&page_tpl=delete&supplier_id={$display_suppliers[s].supplier_id}" onclick="return confirm('{t}Are you Sure you want to delete this Supplier Record? This will permanently remove the record from the database.{/t}');">
