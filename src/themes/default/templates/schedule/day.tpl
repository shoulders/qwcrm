                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" border="0">
                                        <tr>
                                            <td>
                                                ...
                                                <button type="submit" name="ics-schedule" OnClick=location.href="index.php?component=schedule&page_tpl=icalendar&start_year={$start_year}&start_month={$start_month}&start_day={$start_day}&employee_id={$selected_employee}&ics_type=day";>{t}Export{/t} {t}Day Schedule{/t}</button>
