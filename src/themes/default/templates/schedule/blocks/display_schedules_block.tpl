    ...
    {section name=s loop=$display_schedules}
        <tr class="row1" onmouseover="this.className='row2';" onmouseout="this.className='row1';" onDblClick="window.location='index.php?component=schedule&page_tpl=details&schedule_id={$display_schedules[s].schedule_id}';">
            ...
            <td class="olotd4" align="center" nowrap>
                ...
                <a href="index.php?component=schedule&page_tpl=icalendar&schedule_id={$display_schedules[s].schedule_id}" target="_blank"><img src="{$theme_images_dir}icons/16x16/fileprint.gif" border="0" onMouseOver="ddrivetip('{t}Export{/t}');" onMouseOut="hideddrivetip();"></a>
