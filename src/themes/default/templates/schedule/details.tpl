                                    ...
                                    <table width="100%" cellpadding="5" cellspacing="5">
                                        <tr>
                                            <td>
                                                ...
                                                <button type="button" onclick="window.location='index.php?component=schedule&page_tpl=icalendar&schedule_id={$schedule_details.schedule_id}&themeVar=wrapperOff';">{t}Export{/t}</button>                                         
