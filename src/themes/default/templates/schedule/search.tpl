                                ...
                                <td class="menutd">
                                    <table class="menutable" width="100%" border="0" cellpadding="5" cellspacing="0">
                                        <tr>
                                            ...
                                            <!-- Category Search -->
                                            <td valign="top">
                                                <form method="post" action="index.php?component=schedule&page_tpl=search" name="expense_search" id="expense_search">
                                                    <div>                                                        
                                                        <table border="0">
                                                            <tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>  
                                                                {if $previous} 
                                                                    ...
                                                                    <a href="index.php?component=schedule&page_tpl=search&search_category={$search_category}&search_term={$search_term}&page_no={$previous}"><img src="{$theme_images_dir}back_24.gif" border="0" alt=""></a>&nbsp;
                                                                {/if}
                                                            </td>
                                                            ...
                                                            <td>
                                                                {if $next}
                                                                    <a href="index.php?component=schedule&page_tpl=search&search_category={$search_category}&search_term={$search_term}&page_no={$next}"><img src="{$theme_images_dir}forwd_24.gif" border="0" alt=""></a>                                                   
