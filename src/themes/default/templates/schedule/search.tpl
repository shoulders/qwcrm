                                ...
                                <td class="menutd">
                                    <table class="menutable" width="100%" border="0" cellpadding="5" cellspacing="0">
                                        <tr>
                                            ...
                                            <!-- Category Search -->
                                            <td valign="top">
                                                <form method="post" action="index.php?component=schedule&page_tpl=search" name="schedule_search" id="schedule_search" class="remove-empty-values">
                                                    <div>                                                        
                                                        <table border="0">
                                                            <tr>
                                                                <td align="left" valign="top"><b>{t}Search{/t}</b>
                                                                   ...
                                                                   <button type="button" class="olotd4" onclick="window.location.href='index.php?component=schedule&page_tpl=search';">{t}Reset{/t}</button>
                                                                </td>
                                                            </tr>
                                                            <tr>
