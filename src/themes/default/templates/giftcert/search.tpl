                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                {if $previous}
                                                                    ...
                                                                    <a href="index.php?component=giftcert&page_tpl=search&search_category={$search_category}&search_term={$search_term}&page_no={$previous}{if $filter_status}&filter_status={$filter_status}{/if}{if $filter_is_redeemed}&filter_status={$filter_is_redeemed}{/if}"><img src="{$theme_images_dir}back_24.gif" border="0" alt=""></a>&nbsp;
                                                                {/if}
                                                            </td>                                                   
                                                            ...
                                                            <td>
                                                                {if $next}
                                                                    <a href="index.php?component=giftcert&page_tpl=search&search_category={$search_category}&search_term={$search_term}&page_no={$next}{if $filter_status}&filter_status={$filter_status}{/if}{if $filter_is_redeemed}&filter_status={$filter_is_redeemed}{/if}"><img src="{$theme_images_dir}forwd_24.gif" border="0" alt=""></a>                                                   
