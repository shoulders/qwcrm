            ...
            <table width="100%" cellpadding="4" cellspacing="0" border="0" >
                <tr>
                    ...
                    <td class="menuhead2" width="20%" align="right" valign="middle">
                        <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=js}INVOICE_PREFILL_ITEMS_HELP_TITLE{/t}</strong></div><hr><div>{t escape=js}INVOICE_PREFILL_ITEMS_HELP_CONTENT{/t}</div>');" onMouseOut="hideddrivetip();">
                    </td>
                </tr>
                <tr>
                                                ...
                                                <form method="post" action="index.php?component=invoice&page_tpl=prefill_items">
                                                    <table id="prefill_items" class="olotable" width="100%" border="0" cellpadding="5" cellspacing="0">
                                                        ...
                                                        <tr id="dummy_prefill_items_row_iteration" class="dummy_item_row olotd4 row1" style="display: none;">
                                                            ...
                                                            <td class="olotd4" nowrap="">{$currency_symbol}<input id="qform[prefill_items][iteration][unit_net]" name="qform[prefill_items][iteration][unit_net]" class="olotd5" size="10" value="" type="text" maxlength="10" pattern="{literal}[0-9]{1,7}(.[0-9]{0,2})?{/literal}" required disabled onkeydown="return onlyNumberPeriod(event);"></td>
