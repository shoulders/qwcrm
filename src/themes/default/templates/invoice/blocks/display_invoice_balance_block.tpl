...
<table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
    ...
    <tr class="olotd4">
        ...
        {if $invoice_details.tax_system != 'no_tax'}
            <td class="olotd4">{$currency_symbol}{$invoice_details.unit_net|string_format:"%.2f"}</td>
            <td class="olotd4">{$currency_symbol}{$invoice_details.unit_tax|string_format:"%.2f"}</td>
        {/if}
        <td class="olotd4">{$currency_symbol}{$invoice_details.unit_gross|string_format:"%.2f"}</td>
         <td class="olotd4">{$currency_symbol}{($invoice_details.unit_gross - $invoice_details.balance)|string_format:"%.2f"}</td>
        <td class="olotd4"><font color="#cc0000"><b>{$currency_symbol}{$invoice_details.balance|string_format:"%.2f"}</b></font></td>
        <td class="olotd4">
