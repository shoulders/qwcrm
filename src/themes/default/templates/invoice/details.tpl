                                        ...
                                        <tr>
                                            <td class="menutd2">
                                                ...
                                                {if $invoice_details.unit_gross > 0 }                                                      
                                                    <button type="button" onclick="window.open('index.php?component=invoice&page_tpl=print&invoice_id={$invoice_details.invoice_id}&print_type=htmlBrowser&print_content=invoice&themeVar=print');">{t}Print HTML{/t}</button>
                                                    <button type="button" onclick="window.open('index.php?component=invoice&page_tpl=print&invoice_id={$invoice_details.invoice_id}&print_type=pdfBrowser&print_content=invoice&themeVar=print');"><img src="{$theme_images_dir}icons/pdf_small.png"  height="14" alt="pdf">{t}Print PDF{/t}</button>
                                                    <button type="button" onclick="confirm('Are you sure you want to email this invoice to the client?') && $.ajax( { url:'index.php?component=invoice&page_tpl=print&invoice_id={$invoice_details.invoice_id}&print_type=pdfEmail&print_content=invoice&themeVar=print', success: function(data) { $('body').append(data); } } );"><img src="{$theme_images_dir}icons/pdf_small.png"  height="14" alt="pdf">{t}Email PDF{/t}</button>
                                                    <button type="button" onclick="window.open('index.php?component=invoice&page_tpl=print&invoice_id={$invoice_details.invoice_id}&print_type=pdfDownload&print_content=invoice&themeVar=print');"><img src="{$theme_images_dir}icons/pdf_small.png"  height="14" alt="pdf">{t}Download PDF{/t}</button>
                                                    <button type="button" onclick="window.open('index.php?component=invoice&page_tpl=print&invoice_id={$invoice_details.invoice_id}&print_type=htmlBrowser&print_content=client_envelope&themeVar=print');">{t}Print Client Envelope{/t}</button>
                                                    <br>                                                        
                                                    <br>
                                                {/if}
                                                            ...
                                                            <tr class="olotd4">
                                                                ...
                                                                {if $invoice_details.tax_system != 'no_tax'}
                                                                    ...
                                                                    {else}
                                                                        ...
                                                                        <td>{$currency_sym}{$labour_items[l].subtotal_tax|string_format:"%.2f"}</td>
                                                                    {/if}                                                                    
                                                                {/if}
                                                            ...
                                                            <td colspan="10" style="text-align:right;">
                                                                <table style="margin-top: 10px;" width="750" cellpadding="3" cellspacing="0" style="border-collapse: collapse;" align="right">
                                                                    <tr>
                                                                        ...
                                                                        {if $invoice_details.tax_system != 'no_tax'}
                                                                            <td width="80" align="right">{t}Net{/t}: {$currency_sym}{$labour_items_subtotals.subtotal_net|string_format:"%.2f"}</td>
                                                                            <td width="80" align="right">{if '/^vat_/'|preg_match:$invoice_details.tax_system}{t}VAT{/t}{else}{t}Sales Tax{/t}{/if}: {$currency_sym}{$labour_items_subtotals.subtotal_tax|string_format:"%.2f"}</td>
                                                                        {/if}
                                                                        <td width="80" align="right">{t}Gross{/t}: {$currency_sym}{$labour_items_subtotals.subtotal_gross|string_format:"%.2f"}</td>
                                                                    </tr>
                                                                </table>  
                                                            </td>
                                                        </tr>
                                                            ...
                                                            <tr class="olotd4">
                                                                ...
                                                                {if $invoice_details.tax_system != 'no_tax'}
                                                                    ...
                                                                    {else}
                                                                        ...
                                                                        <td>{$currency_sym}{$parts_items[p].subtotal_tax|string_format:"%.2f"}</td>
                                                                    {/if}                                                                    
                                                                {/if}
                                                            ...
                                                            <td colspan="10" style="text-align:right;">
                                                                <table style="margin-top: 10px;" width="750" cellpadding="3" cellspacing="0" style="border-collapse: collapse;" align="right">
                                                                    <tr>
                                                                        ...
                                                                        {/if}
                                                                        <td width="80" align="right">{t}Gross{/t}: {$currency_sym}{$parts_items_subtotals.subtotal_gross|string_format:"%.2f"}</td>
                                                                    </tr>
                                                                </table>  
                                                            </td>
                                                        </tr>
