                                            ...
                                            <tr>
                                                <td class="menutd2">
                                                    ...
                                                    {if $invoice_details.unit_gross > 0 }                                                             
                                                        <button type="button" class="userButton" onclick="window.open('index.php?component=invoice&page_tpl=print&invoice_id={$invoice_details.invoice_id}&commContent=invoice&commType=htmlBrowser&themeVar=print');">{t}Print HTML{/t}</button>
                                                        <button type="button" class="userButton" onclick="window.open('index.php?component=invoice&page_tpl=print&invoice_id={$invoice_details.invoice_id}&commContent=invoice&commType=pdfBrowser&themeVar=print');"><img src="{$theme_images_dir}icons/pdf_small.png"  height="14" alt="pdf">{t}Print PDF{/t}</button>
