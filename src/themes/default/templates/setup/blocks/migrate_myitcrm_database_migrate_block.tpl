...
<form method="post" action="index.php?component=setup&page_tpl=migrate">                   
    <table width="600" cellpadding="5" cellspacing="0" border="0">
        <tr>
            <td class="menuhead2" width="80%">&nbsp;{t}Migrate the Database from MyITCRM to QWcrm{/t}</td>
                   ...
                   <tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            <button class="olotd5" type="submit" name="submit" value="database_migrate">{t}Next{/t}</button>
                        </td>
                    </tr>
                </table>
            </td>
