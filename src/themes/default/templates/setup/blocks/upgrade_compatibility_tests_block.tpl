<!-- upgrade_compatibility_tests_block_block.tpl -->
{*
 * @package   QWcrm
            ...
            <td class="menutd2">
                <table width="600" class="olotable" cellpadding="5" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            <input name="qwcrm_config[myitcrm_prefix]" class="olotd5" size="6" value="{$qwcrm_config.myitcrm_prefix}" type="text" maxlength="6" placeholder="myit_" required onkeydown="return onlyMysqlDatabaseName(event);"/>                            
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td colspan="2" style="text-align: center;">
                            <button class="olotd5" type="submit" name="submit" value="compatibility_test">{t}Next{/t}</button>
                        </td>
                    </tr> 
