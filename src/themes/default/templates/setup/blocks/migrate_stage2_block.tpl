                ...
                <table width="600" class="olotable" cellpadding="5" cellspacing="0" border="0">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <img src="{$theme_images_dir}icons/16x16/help.gif" border="0" onMouseOver="ddrivetip('<div><strong>{t escape=tooltip}Database Tables Prefix{/t}</strong></div><hr><div>{t escape=tooltip}The prefix to for your database tables that are created during the installation process. Do not edit this field unless absolutely necessary (eg the transfer of the database to a new hosting provider).{/t}</div>');" onMouseOut="hideddrivetip();">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td align="right">&nbsp;</td>
                        <td>                                                                                                                   
                            <button type="button" onclick="$.ajax( { url:'index.php?component=administrator:config&send_test_mail=true&theme=print', success: function(data) { $('body').append(data); } } );">{t}Send Test Mail{/t}</button>
                    ...
                    <input type="hidden" name="shared_session" value="0">
                    {*<tr>
                    ...
                    <input type="hidden" name="smarty_debugging" value="0">
                    {*<tr>
                    ...
                    <input type="hidden" name="smarty_debugging_ctrl" value="0">
                    {*<tr>
                    ...
                    {*<tr>
                        <td align="right">&nbsp;</td>
                        <td>                                                                                                                   
                            <button type="button" onclick="$.ajax( { url:'index.php?component=administrator:config&clear_smarty_compile=true&theme=print', success: function(data) { $('body').append(data); } } );">{t}Clear Smarty Compile{/t}</button>
                    ...
                    <input type="hidden" name="smarty_force_cache" value="0">
                    {*<tr>
                    ...
                    <input type="hidden" name="smarty_caching" value="0">
                    {*<tr>
                    ...
                    <input type="hidden" name="smarty_cache_modified_check" value="0">
                    {*<tr>
                    ...
                    <input type="hidden" name="smarty_cache_locking" value="0">
                    {*<tr>
                    ...
                    {*<tr>
                        <td align="right">&nbsp;</td>
                        <td>                                                                                                                   
                            <button type="button" onclick="$.ajax( { url:'index.php?component=administrator:config&clear_smarty_cache=true&theme=print', success: function(data) { $('body').append(data); } } );">{t}Clear Smarty Cache{/t}</button>
