                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <div id="delete_setup_folder">
                                                                                ...
                                                                                <button id="delete_setup_folder_button" type="button" style="display: block; margin: auto auto;" onclick="$.ajax( { url:'index.php?component=setup&page_tpl=upgrade&action=delete_setup_folder&themeVar=printPreview', success: function(data) { $('body').append(data); } } );">{t}Delete Setup Folder{/t}</button>
