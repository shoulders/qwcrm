...
$smarty->assign('employee_workorders_open_count', count_user_workorders_with_status($db, $login_user_id, 10));
...
$smarty->assign('employee_workorders_awaiting_payment_count', count_user_workorders_with_status($db, $login_user_id, 6));

/* Logged in Employee - Unpaid Invoices count - NOT USED*/
$smarty->assign('employee_invoices_unpaid_count', count_user_invoices_with_status($db, $login_user_id, 0));
