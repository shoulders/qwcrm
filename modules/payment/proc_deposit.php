...
if(empty($deposit_amount)) {
    force_page("payment", "new&error_msg=Please Fill in the Deposit amount.&workorder_id=$workorder_id&customer_id=$customer_id&invoice_id=$invoice_id&page_title=Billing");
}

if(empty($deposit_recieved)) {
    force_page("payment", "new&error_msg=Please Fill in the Deposit ID Number.&workorder_id=$workorder_id&customer_id=$customer_id&invoice_id=$invoice_id&page_title=Billing");
}
