...
////////////////  not currently used /////////////////// see payment.php

require(INCLUDES_DIR.'modules/invoice.php');
require(INCLUDES_DIR.'modules/payment.php');
require(INCLUDES_DIR.'modules/workorder.php');

//// add workoreder_id and customer_id as they are not passed
...
if($new_balance == 0 ) {
    ...
    // Update the invoice
    update_invoice_transaction_only($db, $invoice_id, 1, time(), $new_paid_amount, $new_balance);   

    // log message   
    if($cash_amount < $invoice_details['TOTAL']) {
