...
$smarty->assign('open_work_orders',     display_workorders($db, 10, 'DESC', false, 1, 25, $customer_id)     );
$smarty->assign('closed_work_orders',   display_workorders($db, 6, 'DESC', false, 1, 25, $customer_id)      );
$smarty->assign('unpaid_invoices',      display_invoices($db, 0, 'DESC', false, 1, 25, $customer_id)        );
$smarty->assign('paid_invoices',        display_invoices($db, 1, 'DESC', false, 1, 25, $customer_id)        );
