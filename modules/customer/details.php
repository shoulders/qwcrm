...
$smarty->assign('open_workorders',      display_workorders($db, '10', 'DESC', false, 1, 25, NULL, $customer_id) );
$smarty->assign('closed_workorders',    display_workorders($db, '6', 'DESC', false, 1, 25, NULL, $customer_id)  );
