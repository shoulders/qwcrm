...
if(empty($cash_amount)) {
    force_page("billing", "new&error_msg=Please Fill in the cash amount.&workorder_id=$workorder_id&customer_id=$customer_id&invoice_id=$invoice_id&page_title=Billing");
}
