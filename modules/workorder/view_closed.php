...
global $smarty;
	...
	$sql = "SELECT 
			...
			WHERE WORK_ORDER_STATUS=".$db->qstr(6)." GROUP BY ".PRFX."TABLE_WORK_ORDER.WORK_ORDER_ID LIMIT $from, $max_results ORDER BY ".PRFX."TABLE_WORK_ORDER.WORK_ORDER_ID DESC";
