...
if($wo_id == '') {
    force_page('core', 'error', 'error_type=warning&error_location=workorder:details_edit_description&php_function=&error_msg='.$smarty->get_template_vars('translate_workorder_error_message_details_edit_description_loadpage_failed').'&database_error='.$db->ErrorMsg());
    exit;
}
