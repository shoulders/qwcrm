...
if($VAR['print_content'] == '' || $VAR['print_output_method'] == '') {
    force_page('core', 'error', 'error_type=warning&error_location=workorder:print&php_function=&error_msg='.$smarty->get_template_vars('translate_workorder_error_message_print_loadpage_failed').'&php_errormsg='.$php_errormsg.'&database_error='.$db->ErrorMsg());
    exit;
}
