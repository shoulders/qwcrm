...
////////////////////////////////////////////////////////////////
    ...
    public function _applyGSUBsubtable($lookupID, $subtable, $ptr, $currGlyph, $currGID, $subtable_offset, $Type, $Flag, $MarkFilteringSet, $LuCoverage, $level = 0, $currentTag, $is_old_spec, $tagInt)
    {
...
////////////////////////////////////////////////////////////////
    ...
    public function arabic_initialise()
    {
    ...
    public function arabic_shaper($usetags, $scriptTag)
    {
        $chars = array();
        for ($i = 0; $i < count($this->OTLdata); $i++) {
    ...
    public function get_arab_glyphs($char, $type, &$chars, $i, $scriptTag, $usetags)
    {
...
////////////////////////////////////////////////////////////////
// Sets $this->OTLdata[$i]['wordend']=true at possible end of word boundaries
    public function TibetanlineBreaking()
    {
        for ($ptr = 0; $ptr < count($this->OTLdata); $ptr++) {
...
// Sets $this->OTLdata[$i]['wordend']=true at possible end of word boundaries
    public function SEAlineBreaking()
    {
    ...
    public function checkwordmatch(&$dict, $ptr)
    {
        /*
          define("_DICT_NODE_TYPE_SPLIT", 0x01);
          define("_DICT_NODE_TYPE_LINEAR", 0x02);
...
////////////////////////////////////////////////////////////////
    ...
    public function _applyGPOSrules($LookupList, $is_old_spec = false)
    {
        foreach ($LookupList as $lu => $tag) {
    ...
    //////////////////////////////////////////////////////////////////////////////////
    public function _applyGPOSvaluerecord($basepos, $Value)
    {
...
// the last of any Marks which immediately follow the current glyph
    public function _getXAdvancePos($pos)
    {
    ...
    public function _applyGPOSsubtable($lookupID, $subtable, $ptr, $currGlyph, $currGID, $subtable_offset, $Type, $Flag, $MarkFilteringSet, $LuCoverage, $tag, $level = 0, $is_old_spec)
    {
        if (($Flag & 0x0001) == 1) {
            $dir = 'RTL';
    ...
    public function checkContextMatch($Input, $Backtrack, $Lookahead, $ignore, $ptr)
    {
    ...
    public function checkContextMatchMultiple($Input, $Backtrack, $Lookahead, $ignore, $ptr, $class0excl = '', $bclass0excl = '', $lclass0excl = '')
    {
    ...
    public function checkContextMatchMultipleUni($Input, $Backtrack, $Lookahead, $ignore, $ptr, $class0excl = array(), $bclass0excl = array(), $lclass0excl = array())
    {
    ...
    public function _getClassDefinitionTable($offset)
    {
    ...
    public function _getGCOMignoreString($flag, $MarkFilteringSet)
    {
    ...
    public function _checkGCOMignore($flag, $glyph, $MarkFilteringSet)
    {
        $ignore = false;
        // Flag & 0x0008 = Ignore Marks - (unless already done with MarkAttachmentType)
...
////////////////////////////////////////////////////////////////
    ...
    public function _bidiSort($ta, $str = '', $dir, &$chunkOTLdata, $useGPOS)
    {
...
// **********************************************************************************************
    ...
    public function _bidiPrepare(&$para, $dir)
    {
...
// Reorder, once divided into lines
    ...
    public function _bidiReorder(&$chunkorder, &$content, &$cOTLdata, $blockdir)
    {
        $bidiData = array();
...
////////////////////////////////////////////////////////////////
    ...
    public function glyphToChar($gid)
    {
    ...
    public function _getCoverageGID()
    {
    ...
    public function _getOTLscriptTag($ScriptLang, $scripttag, $scriptblock, $shaper, $useOTL, $mode)
    {
...
// LangSys tags
    public function _getOTLLangTag($ietf, $available)
    {
    ...
    public function _dumpproc($GPOSSUB, $lookupID, $subtable, $Type, $Format, $ptr, $currGlyph, $level)
    {
