  ...
  <tr>
    <td class="olotd">
      <table width="100%" cellpadding="4" cellspacing="0" border="0" >
        <tr align="left">
          <td>
            <b>Report Date From: </b></td>
          <td>
            <b>Report Date To: </b></td>
        </tr>
        <tr>
          <td align="left">
...
button      : "trigger_end_date"
      ...
      <table width="100%" class="olotable"  border="0" cellpadding="4" cellspacing="0">
        <tr>
          <td class="olotd">
            <table width="100%" cellpadding="4" cellspacing="0" border="0" >
              <tr>
                ...
                <td class="menuhead2" width="20%" align="right" valign="middle">
                  <img src="images/icons/16x16/help.gif" border="0" 						onMouseOver="ddrivetip('<b>
                  Monthly stats</b>
                  <hr>
                  <p>
