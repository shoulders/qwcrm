                            ...
                            <tr>
                                <td>
                                    ...
                                    <table width="700" cellpadding="4" cellspacing="0" border="0" class="olotable">
                                        ...
                                        <tr class="olotd4">
                                            <td>
                                                { $welcome|default:"Thank you for choosing MYIT CRM. You can Change this note in the Control Center under company setup."}
                                            </td>
                                        </tr>
                                    </table>
                                    <br>
				  ...
				  {if $cred2.EMPLOYEE_TYPE < 3 || $cred2.EMPLOYEE_TYPE > 3 }
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" border="0" class="olotable">
                                        <tr class="olotd4">
                                            ...
                                            <td class="row2">
                                                <b>{$translate_current_total}</b>
                                            </td>
                                            <td class="row2">
                                                <b>{$translate_actual_total}</b>
                                            </td>
                                        </tr>
                                        <tr class="olotd4">
                                            <td>
                                            ...
                                            <td>
                                                <font color="#cc0000">{$currency_sym}{$in_unpaid_bal|string_format:"%.2f"}</font>
                                            </td>
                                            <td>
                                            ...
                                            <td>
                                                <font color="green">{$currency_sym}{$in_total_bal|string_format:"%.2f"}</font>
                                            </td>
                                            <td>
                                                <font color="green">{$currency_sym}{$in_total2|string_format:"%.2f"}</font>
                                            </td>
                                        </tr>
                                    </table>
                                    <br>{/if}
