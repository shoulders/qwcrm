...
<table width="150"   border="2" cellspacing="0" cellpadding="0">
	...
	<div style="float: left" id="my_menu" class="sdmenu">
      ...
      <div class="collapsed">
		...
		<a href="?page=customer:view&amp;page_title={$translate_menu_customers}"><img src="images/icons/16x16/view+.gif" alt="" border="0" height="14" width="14" /> {$translate_menu_new}</a>
		{if $unassigned > 0 }
