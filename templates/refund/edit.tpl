                                                                ...
                                                                <table width="100%" cellpadding="2" cellspacing="2" border="0">
                                                                    ...
                                                                    {section name=q loop=$refund_details}
                                                                            ...
                                                                            <tr>
                                                                                ...
                                                                                <td><textarea class="olotd5" name="refundNotes" cols="50" rows="10">{$refund_details[q].REFUND_NOTES}</textarea></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td align="right"><b>{$translate_refund_items}</b><span style="color: #ff0000"> *</span></td>
                                                                                <td><textarea class="olotd5" name="refundItems" cols="50" rows="10">{$refund_details[q].REFUND_ITEMS}</textarea></td>
                                                                            </tr>
                                                                            <tr>
                                                                                <td></td>
