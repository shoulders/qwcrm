                        ...
                        {section name=q loop=$company}
                            ...
                            <table cellpadding="5" cellspacing="0">
                                <tr>
                                    ...
                                    <td><input class="olotd5" type="text" name="company_name"
                                               value="{$company[q].COMPANY_NAME}"</td>
                                </tr>
                                <tr>
                                    <td align="right"><label  for="file"><b>Logo Filename:</b></label></td>
                                    <td>
                                        <input type="file" name="file" id="file" /> <img src="{$company[q].COMPANY_LOGO}" height="50px" alt="{$company[q].COMPANY_LOGO}"><br><a>Current Logo Path : {$company[q].COMPANY_LOGO}</a>

                                    </td>
                                </tr>
                                <tr>
                                    <td align="right"><b>Company ABN:</b></td>
                                    <td><input class="olotd5" type="text" name="company_abn"
                                               value="{$company[q].COMPANY_ABN}"></td>
                                </tr>
                                <tr>
                                    <td align="right"><b>Address:</b></td>
                                    <td><textarea class="olotd5" cols="30" rows="3"
                                                  name="address">{$company[q].COMPANY_ADDRESS}</textarea></td>
                                </tr>
                                <tr>
                                    <td align="right"><b>City:</b></td>
                                    <td><input class="olotd5" type="text" name="city"
                                               value="{$company[q].COMPANY_CITY}"></td>
                                </tr>
                                <tr>
                                    <td align="right"><b>State:</b></td>
                                    <td><input class="olotd5" type="text" name="state"
                                               value="{$company[q].COMPANY_STATE}">
                                    </td>
                                </tr>
                                <tr>
                                    <td align="right"><b>Zip:</b></td>
                                    <td><input class="olotd5" type="text" name="zip" value="{$company[q].COMPANY_ZIP}">
                                    </td>
                                </tr>
                                <tr>
                                    ...
                                    <td>
                                        <select name="country" class="olotd5">
                                            {section name=c loop=$country}
                                                <option value="{$country[c].code}" {if $company[q].COMPANY_COUNTRY == $country[c].code}
                                                        selected {/if} >{$country[c].name}</option>
                                ...
                                <tr>
                                    ...
                                    <td><input class="olotd5" type="text" name="phone"
                                               value="{$company[q].COMPANY_PHONE}"></td>
                                </tr>
                                <tr>
                                    <td align="right"><b>Mobile Phone:</b></td>
                                    <td><input class="olotd5" type="text" name="mobile_phone"
                                               value="{$company[q].COMPANY_MOBILE}"></td>
                                </tr>
                                <tr>
                                    <td align="right"><b>Fax:</b></td>
                                    <td><input class="olotd5" type="text" name="fax" value="{$company[q].COMPANY_FAX}">
                                    </td>
                                </tr>
                                {section name=w loop=$setup}
                                    <tr>
                                        <td align="right"><b>Tax Amount:</b></td>
                                        <td><input type="text" size="6" name="inv_tax" value="{$setup[w].INVOICE_TAX}"
                                                   class="olotd5">%
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="right"><b>Invoice Starting Number:</b></td>
                                        <td><input class="olotd5" type="text" name="inv_number"
                                                   value="{$setup[w].INVOICE_NUMBER_START}"></td>
                                    </tr>
                                    <tr>
                                        <td colspan="3" align="center"><b>eg: 2000 - this will start invoice increments
                                    ...
                                    <tr>
                                        <td colspan="2"><textarea class="olotd5" cols="80" rows="5"
                                    ...
                                    <tr>
                                        <td colspan="2"><input class="olotd5" type="submit" name="submit"
                                                               value="Update"></td>
                                    </tr>
                        ...
                        {section name=q loop=$company}
                            <table cellpadding="5" cellspacing="0">
                                <tr>
                                    ...
                                    <td><input class="olotd5" type="text" size="5" name="currency_sym"
                                               value="{$company[q].COMPANY_CURRENCY_SYMBOL}"></td>
                                </tr>
                                <tr>
                                    <td align="right"><b>Currency Code:</b></td>
                                    <td><input class="olotd5" type="text" size="5" name="currency_code"
                                               value="{$company[q].COMPANY_CURRENCY_CODE}">eg: "USD" = US Dollars, "AUD"
                                        = Australian Dollars, "GBP" = British Pound.
                                    </td>
                                ...
                                <tr>
                                    ...
                                    <td><select name="date_format" class="olotd5">
                                        <option value="%d/%m/%Y"
                                        { if $company[q].COMPANY_DATE_FORMAT == '%d/%m/%Y' } SELECTED {/if}
                                        >dd/mm/yyyy</option>
                                        <option value="%m/%d/%Y"
                                        { if $company[q].COMPANY_DATE_FORMAT == '%m/%d/%Y' } SELECTED {/if}
                                        >mm/dd/yyyy</option>
                                        <option value="%d/%m/%y"
                                        { if $company[q].COMPANY_DATE_FORMAT == '%d/%m/%y' } SELECTED {/if}
                                        >dd/mm/yy</option>
