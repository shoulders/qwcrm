                                    ...
                                    <table width="700" cellpadding="5" cellspacing="0" border="0" >
                                        <tr>
                                            ...
                                            <td class="menuhead2" width="20%" align="right" valign="middle">
                                                <a href="index.php?page=workorder:print&amp;wo_id=2&page_title=Print&escape=1" target="_blank"><img src="images/icons/print.gif" alt="Print Works Order" border="0" height="14" width="14" onMouseOver="ddrivetip('<b>Print Works Order</b>')" onMouseOut="hideddrivetip()" /></a>
