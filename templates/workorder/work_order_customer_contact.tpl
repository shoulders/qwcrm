									...
									<table width="100%" cellpadding="0" cellspacing="0" border="0">
										<tr>
											...
											<td class="menuhead2" width="20%" align="right">
												...
												<tr>
                                                                                                    <td width="33%" align="right" ><a href="?page=customer:edit&customer_id={$single_workorder_array[i].CUSTOMER_ID}&page_title={$single_workorder_array[i].CUSTOMER_DISPLAY_NAME}"><img src="images/icons/16x16/small_edit.gif" border="0" onMouseOver="ddrivetip('Edit Customer')" onMouseOut="hideddrivetip()"></a></td>
												</tr>
                                                                                            </table>
											</td>
										</tr>
									...
									<table class="olotable" border="0" cellpadding="5" cellspacing="5" width="100%" summary="Customer Contact">
										<tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td class="menutd">{$single_workorder_array[i].CUSTOMER_ADDRESS|nl2br}<br>{$single_workorder_array[i].CUSTOMER_CITY}<br>{$single_workorder_array[i].CUSTOMER_STATE}<br>{$single_workorder_array[i].CUSTOMER_ZIP}</td>
