        ...
        <tr>					
          ...
          <td class="menuhead2" size="10%" align="right">
            <a href="http://www.citecrm.com/docs/#work_orders" target="new">
              <img src="images/icons/16x16/help.gif" border="0"></a>				
        </tr>
        <tr>					
                          ...
                          <tr>													
                            ...
                            <td class="menuhead2" width="20%" align="right">														
                              <a href="?page=customer:edit&customer_id={$customer_details[i].CUSTOMER_ID}">															
                                <img src="images/icons/16x16/small_edit.gif" border="0" 															onMouseOver="ddrivetip('Edit Customer')" onMouseOut="hideddrivetip()">														</a>													</td>												
                          </tr>											
                        </table>										</td>									
                    </tr>
                    <tr>						 										
