    ...
    <tr>
        <td width="50%">
            <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                    <td><b>{$single_workorder_array[i].CUSTOMER_DISPLAY_NAME}</b>
                ...
                <tr>
                    <td><b>Contact:</b> {$single_workorder_array[i].CUSTOMER_FIRST_NAME} {$single_workorder_array[i].CUSTOMER_LAST_NAME}
                    <br /><b>Phone:</b> {$single_workorder_array[i].CUSTOMER_PHONE}<br>
                    ...
                    <!-- <b>Type:</b> {$single_workorder_array[i].CUSTOMER_TYPE} -->
                    </td>
                </tr>
            </table>
        ...
        <td width="50%">
            <table width="100%" cellpadding="4" cellspacing="0" border="0">
                {section name=d loop=$company}
                    <tr>
                        <td><b>{$company[d].COMPANY_NAME}</b><br>
        ...
        <td valign="top" width="60%">
            <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                    ...
                    <td>{$single_workorder_array[i].WORK_ORDER_DESCRIPTION }
                    </td>
                </tr>
            </table>
            <hr>
            <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                    ...
                    <td>{$single_workorder_array[i].WORK_ORDER_COMMENT}
                    </td>
                </tr>
            </table>
            <hr>
            <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                    ...
                    <b>Technician: </b>{$work_order_notes[b].EMPLOYEE_DISPLAY_NAME}  
                    <br><b>Date: </b> {$work_order_notes[b].WORK_ORDER_NOTES_DATE|date_format:"$date_format"}
                    <br>{$work_order_notes[b].WORK_ORDER_NOTES_DESCRIPTION}<br>
                    </p>
                        {/section}
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    {section name=r loop=$work_order_res}
                        {if $work_order_res[r].EMPLOYEE_DISPLAY_NAME != ''}
                            <b>Closed By:</b> {$work_order_res[r].EMPLOYEE_DISPLAY_NAME}<br /> <b>Date:</b>  {$work_order_res[r].WORK_ORDER_CLOSE_DATE|date_format:"$date_format"}
        ...
        <td valign="top" width="20%">
            <table border="0" cellpadding="4" cellspacing="0">
                <tr>
                    ...
                    <td valign="top">
                        #{$single_workorder_array[i].WORK_ORDER_ID}
                    </td>
                </tr>
                <tr>
