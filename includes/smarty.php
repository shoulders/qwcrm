...
$smarty->force_compile          = $GConfig->smarty_force_compile;
$smarty->caching                = $GConfig->smarty_caching;
$smarty->cache_lifetime         = $GConfig->smarty_cache_lifetime;
$smarty->cache_modified_check   = $GConfig->smarty_cache_modified_check;         // Smarty will respect the If-Modified-Since header sent from the client. Only works with caching enabled
