...
/******************************************************************************************/
    ...
    protected static function createSession(array $options = array())
    {
        ...
        //$handler = $conf->get('session_handler', 'database'); - might not be needed
        $store = $conf->get('session_handler', 'none');   
        ...
        $session = new QSession($store, $options);
