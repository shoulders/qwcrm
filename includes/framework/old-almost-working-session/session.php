...
//class JSession extends JFactory {    
class JSession {     
   ...
   // protected $data;
    ...
    public function __construct(array $options = null)
    {
        ...
        // do i need this statement - i think this is handled in start
...
/******************* Start Operations *******************/    
   ...
   public function buildSessionOptions() {        
	...
	//$handler = $this->get('sess_handler', 'none');
        ...
        // Initialization the options for JSession.
        $options = array(
            'name'   => $name,
            'expire' => $lifetime,
        );
...
/******************* Token Operations *******************/
   ...
   /**
    ...
    public static function getFormToken($forceNew = false)
    {
        ...
        return JFactory::getHash($user->get('id', 0) . $session->getToken($forceNew));
    } 
...
/******************* Set Operations *******************/    
    ...
    protected function _setOptions(array $options)
    {
        ...
        {        
            ...
            //$this->setName(md5(JFactory::getHash($options['name'])));            
